...
namespace Acurus.Capella.DataAccess.ManagerObjects
{
    ...
    public partial class PastMedicalHistoryMasterManager : ManagerBase<PastMedicalHistoryMaster, uint>, IPastMedicalHistoryMasterManager
    {
        ...
        public PastMedicalHistoryMasterManager()
            : base()
        {

        }
        public PastMedicalHistoryMasterManager(INHibernateSession session)
            : base(session)
        {
        ...
        #endregion
        int iTryCount = 0;
        //public ProblemHistoryDTO SaveUpdateDeleteProblemMedicalHistory(IList<PastMedicalHistoryMaster> insertList, IList<PastMedicalHistoryMaster> updateList, IList<PastMedicalHistoryMaster> deleteList, GeneralNotes generalNotesObject, string macAddress, ulong Encounter_ID, ulong Human_Id, ulong Physician_ID, string UserName, DateTime date, string medicalInfo, string Version_Yr, Dictionary<string,string> ICDCodes)
        //{
        ...
        //    IList<PastMedicalHistoryMaster> CheckPastMedicalHistory = new List<PastMedicalHistoryMaster>();
        ...
        //    IList<PastMedicalHistoryMaster> past=new List<PastMedicalHistoryMaster>();
