...
//      var txtMessage="---------------------------------------------------------";
//      txtMessage +="<br/>"+"From: "+cellFrom.innerHTML; 
//      txtMessage +="<br/>"+ "To: "+cellToAddress.innerHTML;
//      txtMessage += "<br/>"+ "Message Date&Time: "+cellDateTime.innerHTML;
//      txtMessage +="<br/>"+ "---------------------------------------------------------";
//      txtMessage +="<br/>"+"Message From:"+cellFrom.innerHTML;
//      txtMessage +="<br/>"+"Message To:"+cellToAddress.innerHTML;
//      txtMessage +="<br/>"+"Subject:"+cellSubject.innerHTML;
//      txtMessage +="<br/>"+"Body:"+cellBody.innerHTML.replace("&nbsp;","<br/>");
//      var WindowManager= $find('WindowMngr').GetWindowByName('MessageWindow'); 
//      var Reply=$find('btnReply');
//      var Forward=$find('btnForward');
//      var win = radalert(txtMessage,null,null,WindowManager.get_title());
//      win.setSize(387, 227);
//      //win.center();
// 
...
function DisableControls()
{
    ...
    $find("cboProvider").disable();
           ...
           // document.getElementById("cboProvider").value = 0;
...
function OnRowDblClick(sender,eventArgs)
{
    ...
    setTimeout(function(){GetRadWindow().BrowserWindow.openModal("frmMailMessage.aspx",720, 800,obj,"MessageWindow");},0);
...
function enableprovider() {
    ...
    // document.getElementById("rdbtnProvider").disabled = false;
}
function cmboproviderchange() {
    if (document.getElementById("cboProvider").value == "Others") {
        ...
        // document.getElementById("txtDirectAddress").Focus();
    }
    else {
        $find("txtDirectAddress").disable();
...
function Forward()
{
    ...
    setTimeout(function () { GetRadWindow().BrowserWindow.openModal("frmSendHealthRecord.aspx", 420, 607, obj, "MessageWindow"); }, 0);
}
...
function Providerchange()
{
    ...
    $find("txtDirectAddress").disable();
    //document.getElementById("txtSentTo").disabled = true;

   // document.getElementById("cboProvider").disabled=false;
    
   // document.getElementById("txtDirectAddress").disabled = true;
    $find("txtDirectAddress").clear();
    $find("txtSentTo").clear();
   // document.getElementById("cboProvider").value = 0;
    $find("cboProvider").clearSelection();
    //var dropdownlist = $find("cboProvider");
    //var item = dropdownlist.findItemByText("");
    //item.select();
