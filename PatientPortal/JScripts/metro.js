...
$.widget( "metro.treeview" , {
    ...
    _createEvents: function(){
        ...
        element.on('click', 'li', function (e) {
            ...
            if (e.currentTarget.id != "" && sChecki != "1") {
                if (e.currentTarget.className == "node collapsed")
                    e.currentTarget.className = "node";
                else
                    e.currentTarget.className = "node collapsed";
            }
            else if (sChecki == '') {
                sChecki = "1";
        ...
        element.on('click', '.para', function(){
            var leaf = $(this),
                node = $(leaf.parents('.node')[0]),
                parent = leaf.parent('li');

            element.find('.para').parent('li').removeClass('active');
        ...
        if (o.doubleClick) {
            element.on('dblclick', '.para', function (e) {
        ...
        element.on('click', '.node-toggle', function(e){
            var leaf = $(this).siblings('.para'), parent = $(this).parent('li'), node = $(leaf.parents('.node')[0]);
            var result;
