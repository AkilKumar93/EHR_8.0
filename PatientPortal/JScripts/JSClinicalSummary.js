function OpenPDF() {
    ...
    //setTimeout(function(){GetRadWindow().BrowserWindow.openModal('frmPrintPDF.aspx',835,900,obj,"ModalWindow");},0);
...
function btnSendSummary_Clicked(sender, args) {
    //var Email = document.getElementById('txtRecAdd').value;//For bug Id 61902
    var Email = $("#DLCRecAdd_txtDLC")[0].value;
    if (Email != '') {
        if (!IsEmail(Email))
        {
            DisplayErrorMessage('420030');
            //document.getElementById('txtRecAdd').focus();
