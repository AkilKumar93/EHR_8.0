<%@ Page  Async="true" Language="C#" AutoEventWireup="true" CodeBehind="frmSessionExpired.aspx.cs" Inherits="Acurus.Capella.PatientPortal.frmSessionExpired" %>
...
<body onload=" {sessionStorage.setItem('StartLoading', 'false');StopLoadFromPatChart();}" style="height: 90%; width: 99%;">
    <form id="frmSessionExpired" runat="server">
        <div style="text-align: center; vertical-align: middle; padding-top: 20%; width: 480px; height: 100px; padding-left: 31%;">
            <div style="border: medium; width: 100%; height: 100%;">
                <table class="tablebordered" style="height:100px;">
                    <thead>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-primary htmlbtnstyle" OnClick="btnLogin_Click" OnClientClick="return SessionExpired();"
                                    Text="Click here to Login"  style="display:none"/>
                            </td>
                        </tr>
                    </tbody>
                </table>
