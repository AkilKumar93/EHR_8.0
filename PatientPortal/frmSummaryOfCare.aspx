<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="frmSummaryOfCare.aspx.cs"
    Inherits="Acurus.Capella.PatientPortal.frmSummaryOfCare" %>
...
<head runat="server">
    ...
    <script type="text/javascript" id="telerikClientEvents1">
        function btnFindPatient_Clicked(sender, args) {
            var obj = new Array();
            obj.push("Scan=Yes");
            var result = openModal("frmFindPatient.aspx", 250, 1200, obj, "RadPatientWindow");
        ...
        function btnOK_ClientClick(sender, args) {
            ...
            win.center();
            //            var obj = new Array();
            //            obj.push("XMLPath=" + document.getElementById('hdnXMLPath').value);
    ...
    <form id="form1" runat="server">
        ...
        <div style="display: block; height: 100%; width: 100%;">
            <div style="display: inline-block; height: 830px; width: 24%; float: left;">
                <asp:Panel ID="pnlSummarylst" GroupingText="Select Sections" runat="server">
                    <asp:CheckBoxList ID="SummaryCheckList" runat="server"></asp:CheckBoxList>
                </asp:Panel>
                            ...
                            <td>
                                <asp:Panel ID="Panel1" runat="server" Height="100%" Width="100%">
                                    <table style="width: 100%; height: 100%">
                                        <tr>
                                            <td width="20%">
                                                <asp:Label ID="lblSelect" runat="server" Text="Select Selection"></asp:Label>
                                            </td>
                                            <td width="30%">
                                                <telerik:RadComboBox ID="cboSelection" runat="server" Width="100%" OnSelectedIndexChanged="cboSelection_SelectedIndexChanged"
                                                    AutoPostBack="true">
                                                </telerik:RadComboBox>
                                            </td>
                                            <td width="50%">&nbsp;
                                    ...
                                    <tr>
                                        <td align="right">
                                            <telerik:RadButton ID="btnOK" Text="Reconcile" AutoPostBack="true" runat="server" Visible="false"
                                                OnClientClicked="btnOK_ClientClick" OnClick="btnOK_Click">
                                            </telerik:RadButton>
                                        </td>
                                        <td align="right">
