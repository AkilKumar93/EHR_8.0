...
{
    [DataContract]
     public partial class ObjectProcessHistoryBillingTemp : BusinessBase<ulong>
    {
        #region Declarations
        ...
        private string _Is_Marked_in_History_Table = string.Empty;
        ...
        public ObjectProcessHistoryBillingTemp() { }
        ...
        public override int GetHashCode()
        {
            ...
            sb.Append(_Is_Marked_in_History_Table);
        ...
        [DataMember]
        public virtual string Is_Marked_in_History_Table
        {
            get { return _Is_Marked_in_History_Table; }
            set
            {
                _Is_Marked_in_History_Table = value;
            }
        }
        #endregion
    }
