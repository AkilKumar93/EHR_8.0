...
{
    [DataContract]
    public partial class RegistryLog : BusinessBase<ulong>
    {
        #region Declarations
        ...
        private string _Registry_Type = string.Empty;
        ...
        [DataMember]
        public virtual string Registry_Type
        {
            get { return _Registry_Type; }
            set
            {
                _Registry_Type = value;
            }
        }
        [DataMember]
