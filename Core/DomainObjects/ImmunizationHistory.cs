...
namespace Acurus.Capella.Core.DomainObjects
{
    ...
    public partial class ImmunizationHistory : BusinessBase<ulong>
    {
        #region Declarations
        private ulong _Human_ID = 0;
        private ulong _Immunization_History_Master_ID = 0;
        ...
        public override int GetHashCode()
        {
            ...
            sb.Append(_Human_ID);
            sb.Append(_Immunization_History_Master_ID);
        ...
        public virtual ulong Immunization_History_Master_ID
        {
            get { return _Immunization_History_Master_ID; }
            set
            {
                _Immunization_History_Master_ID = value;
            }
        }
