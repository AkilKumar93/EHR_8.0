...
{
    [DataContract]
    public partial class VisitPaymentHistory: BusinessBase<ulong>
    {
        #region Declarations
        ...
        private ulong _Visit_Payment_History_ID = 0;
        ...
        public override int GetHashCode()
        {
            ...
            sb.Append(_Visit_Payment_History_ID);
        ...
        [DataMember]
        public virtual ulong Visit_Payment_History_ID
        {
            get { return _Visit_Payment_History_ID; }
            set
            {
                _Visit_Payment_History_ID = value;
            }
        }
        #endregion
    }
