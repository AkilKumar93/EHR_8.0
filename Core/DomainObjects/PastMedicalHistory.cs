...
{
    [Serializable]
    public partial class PastMedicalHistory : BusinessBase<ulong>
    {
        #region Parameter Variable Decleration

        private ulong _Past_Medcial_History_ID=0;
        private ulong _Past_Medical_History_Master_ID = 0;        
        ...
        public override int GetHashCode()
        {
            ...
            sb.Append(_Past_Medcial_History_ID);
            sb.Append(_Past_Medical_History_Master_ID);
            sb.Append(_Human_ID);
        ...
        public virtual ulong Past_Medical_History_Master_ID
        {
            get { return _Past_Medical_History_Master_ID; }
            set { _Past_Medical_History_Master_ID = value; }
        }
        public virtual ulong Past_Medcial_History_ID
        {
            get { return _Past_Medcial_History_ID; }
            set { _Past_Medcial_History_ID = value; }
        }
