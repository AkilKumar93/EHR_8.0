...
namespace Acurus.Capella.GenerateCCD
{
    public partial class HL7Generator
    {
        ...
        MemoryStream ms;
        XmlWriter xmlWriter;
        StateManager objCounty = new StateManager();
        public XmlDocument CreateCarePlanXML(PhysicianLibrary Phy, FillClinicalSummary ClinicalSummary, string sPrintFileName)
        {
            ...
            //HimajaxmlDoc.Load(Path.Combine(System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath, "SampleXML\\Care_Plan_Sample.xml"));
            xmlDoc.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Care_Plan_Sample.xml"));
            ...
            if (ClinicalSummary.PhysicianLibraryDocumentation != null && ClinicalSummary.PhysicianLibraryDocumentation.Count != 0)
            {
                for (int i = 0; i < ClinicalSummary.PhysicianLibraryDocumentation.Count; i++)
                {
                    ...
                    //docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\+ "\\CareTeam.xml"));
            ...
            if (ClinicalSummary.ProblemListing != null && ClinicalSummary.ProblemListing.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[3].InnerText == "Health Concerns Section")
                {
                    ...
                    for (int i = 0; i < ClinicalSummary.ProblemListing.Count; i++)
                    {
                        ...
                        sInnerXML += "<tr><td>" + ClinicalSummary.ProblemListing[i].Problem_Description + ", " + ClinicalSummary.ProblemListing[i].Status + "</td><td>" + "Active" + "</td><td>" + sDate + "</td></tr>";
                    ...
                    //HimajadocAllergyEntry.Load(Path.Combine(System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath, "SampleXML\\HealthConcern_Careplan.xml"));
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\HealthConcern_Careplan.xml"));
                ...
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[3].ChildNodes[0].ChildNodes[3].InnerText == "Goals Section")
                {
                    ...
                    for (int i = 0; i < ClinicalSummary.TreatmentPlan.Count; i++)
                    {
                        ...
                        if (ClinicalSummary.TreatmentPlan[i].Plan_For_Plan.Trim() != "")
                            sInnerXML += "<tr><td>" + ClinicalSummary.TreatmentPlan[i].Plan.Replace("-Vitals", "").Replace("-Problem List", "").Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("'", "&apos;").Replace("\"", "&quot;") + " - " + ClinicalSummary.TreatmentPlan[i].Plan_For_Plan + "</td><td> N/A </td><td>" + ClinicalSummary.Encounter[0].Date_of_Service.ToString("MMMM dd, yyyy") + "</td></tr>";
                        else
                    ...
                    //HimajadocAllergyEntry.Load(Path.Combine(System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath, "SampleXML\\Goal_Section.xml"));
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Goal_Section.xml"));
            ...
            if (ClinicalSummary.Careplan != null && ClinicalSummary.Careplan.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[5].ChildNodes[0].ChildNodes[3].InnerText == "Interventions Section")
                {
                    ...
                    //        docAllergyEntry1.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\+ "\\EncounterDiagnosis.xml"));
            ...
            if (ClinicalSummary.Vitals != null && ClinicalSummary.Vitals.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[3].InnerText == "Health Status Evaluations/Outcomes Section")
                {
                    ...
                    //HimajadocAllergyEntry.Load(Path.Combine(System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath, "SampleXML\\Health_Status_Evaluation.xml"));
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Health_Status_Evaluation.xml"));
                    ...
                    for (int i = 0; i < ClinicalSummary.Vitals.Count; i++)
                    {
                        ...
                        if (i == ClinicalSummary.Vitals.Count - 1)
                        {
                            ...
                            //HimajadocvitalEntry.Load(Path.Combine(System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath, "SampleXML\\Health_Status_Evaluation_Last_Entry_Section.xml"));
                            docvitalEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Health_Status_Evaluation_Last_Entry_Section.xml"));
        ...
        public XmlDocument CreateCCDXML(PhysicianLibrary Phy, FillClinicalSummary ClinicalSummary, string sPrintFileName, Hashtable hashCheckedList)
        {
            ...
            xmlDoc.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), ("SampleXML" + "\\CCD_Sample.xml")));
            XmlNodeList xmlReqNode = null;
            string sContent = string.Empty;
            xmlReqNode = xmlDoc.GetElementsByTagName("effectiveTime");
            xmlReqNode[0].Attributes[0].Value = DateTime.Now.ToString("yyyyMMddhhmmss+0500");
            ...
            if (ClinicalSummary.Allergy != null && ClinicalSummary.Allergy.Count != 0 && hashCheckedList["chkAllergies"].ToString().ToUpper() == "TRUE")
            {
                ...
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[3].InnerText == "Allergies")
                {
                    ...
                    if (hashCheckedList["chkAllergies"].ToString().ToUpper() == "TRUE")
                    {
                        ...
                        for (int i = 0; i < ClinicalSummary.Allergy.Count; i++)
                        {
                            ...
                            if (ClinicalSummary.Allergy[i].Allergy_Name.ToString().ToUpper() == "NKDA")
                                ...
                                sInnerXML += "<tr><td>" + ClinicalSummary.Allergy[i].Allergy_Name + ", RxNorm: " + response + "(IN)</td><td>" + sReaction + ", SNOMED-CT: " + ClinicalSummary.Allergy[i].First_DataBank_Med_ID + "</td><td>" + sSeverity + "</td><td>Active</td></tr>";
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), ("SampleXML" + "\\Allergy_Entry.xml")));
            ...
            else
            {
                ...
                XmlElement xelemSection = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0];
                XmlDocument docAllergyEntry = new XmlDocument();
                docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), ("SampleXML" + "\\Allergies_Nullflavor.xml")));
                XmlDocumentFragment xfragAllergy = xmlDoc.CreateDocumentFragment();
                xfragAllergy.InnerXml = docAllergyEntry.DocumentElement.InnerXml;
            ...
            if (ClinicalSummary.Encounter != null && ClinicalSummary.Encounter.Count != 0 && hashCheckedList["chkEncounter"].ToString().ToUpper() == "TRUE")
            {
                ...
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[3].ChildNodes[0].ChildNodes[2].InnerText == "Encounters Diagnosis")
                {
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\Encounter.xml"));
            ...
            if (ClinicalSummary.immunhistoryList != null && ClinicalSummary.immunhistoryList.Count != 0 && hashCheckedList["chkImmunization"] != null && hashCheckedList["chkImmunization"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[5].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "IMMUNIZATIONS")
                {
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\Immunization.xml"));
                    int iOldValue = 0;
            ...
            if (ClinicalSummary.MedicationAdministrative != null && ClinicalSummary.MedicationAdministrative.Count != 0 && hashCheckedList["chkMedicationAdministrative"] != null && hashCheckedList["chkMedicationAdministrative"].ToString().ToUpper() == "TRUE")
            {
                ...
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[3].InnerText == "Medications Administered")
                {
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\MedicationAdministration.xml"));
                    int iOldValue = 0;
                ...
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[9].ChildNodes[0].ChildNodes[4].InnerText == "Medications")
                {
                    ...
                    if (hashCheckedList["chkMedication"].ToString().ToUpper() == "TRUE")
                    {
                        for (int i = 0; i < ClinicalSummary.Medication.Count; i++)
                        {
                            ...
                            {
                                sInnerXML += "<tr><td><content ID='" + "Med" + i.ToString() + "'>" + ClinicalSummary.Medication[i].Brand_Name + " " + ClinicalSummary.Medication[i].Strength + ", RXNorm: " + ClinicalSummary.Medication[i].Rxnorm_ID + " (" + ClinicalSummary.Medication[i].Rxnorm_ID_Type + ")" + "</content></td><td>" + ClinicalSummary.Medication[i].Action + " " + ClinicalSummary.Medication[i].Dose + " " + ClinicalSummary.Medication[i].Dose_Unit + " " + ClinicalSummary.Medication[i].Dose_Timing + " " + ClinicalSummary.Medication[i].Dose_Other + " " + ClinicalSummary.Medication[i].Patient_Notes + "</td><td>" + ClinicalSummary.Medication[i].Start_Date.ToString("MMMM dd,yyyy") + "</td><td>" + ClinicalSummary.Medication[i].Stop_Date.ToString("MMMM dd,yyyy") + "</td><td>Active</td></tr>";
                            }
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\Medication.xml"));
                    int iOldValue = 0;
            ...
            if (ClinicalSummary.ReferralOrder != null && ClinicalSummary.ReferralOrder.Count != 0 && hashCheckedList["chkReasonforReferral"] != null && hashCheckedList["chkReasonforReferral"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "REASON FOR REFERRAL")
                {
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\ReasonforReferral.xml"));
            ...
            if (ClinicalSummary.ProblemListing != null && ClinicalSummary.ProblemListing.Count != 0 && hashCheckedList["chkProblemList"] != null && hashCheckedList["chkProblemList"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[3].InnerText.ToUpper() == "PROBLEMS")
                {
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\Problem.xml"));
                    int iOldValue = 0;
            ...
            else
            {
                ...
                XmlElement xelemSection = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0];
                XmlDocument docAllergyEntry = new XmlDocument();
                docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\ProblemlistNullflavor.xml"));
                XmlDocumentFragment xfragAllergy = xmlDoc.CreateDocumentFragment();
                xfragAllergy.InnerXml = docAllergyEntry.DocumentElement.InnerXml;
                xelemSection.AppendChild(xfragAllergy);
            ...
            if (ClinicalSummary.laborderList != null && ClinicalSummary.laborderList.Count != 0 && hashCheckedList["chkProcedures"] != null && hashCheckedList["chkProcedures"].ToString().ToUpper() == "TRUE")
            {
                ...
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[17].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "PROCEDURES")
                {
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\Procedures.xml"));
                    int iOldValue = 0;
            ...
            if (ClinicalSummary.ResultList != null && ClinicalSummary.ResultList.Count != 0 && hashCheckedList["chkLaboratoryResultValues"] != null && hashCheckedList["chkLaboratoryResultValues"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "RESULTS")
                {
                        ...
                        for (int i = 0; i < ClinicalSummary.ResultList.Count; i++)
                        {
                            ...
                            if (!ClinicalSummary.ResultList[i].OBX_Observation_Value.ToUpper().Contains("SEE REPORT BELOW: "))
                            {
                                ...
                                sInnerXML += "<tr><td>" + ClinicalSummary.ResultList[i].OBX_Observation_Text.Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("'", "&apos;").Replace("\"", "&quot;")
                                    + ", LOINC: " + ClinicalSummary.ResultList[i].OBX_Observation_Identifier.Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("'", "&apos;").Replace("\"", "&quot;")
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\Result.xml"));
                ...
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[25].ChildNodes[0].ChildNodes[3].InnerText.ToUpper() == "SOCIAL HISTORY")
                {
                    ...
                    for (int i = 0; i < ilstSocialHistory1.Count; i++)
                    {
                        ...
                        if (ilstSocialHistory1[i].Social_Info.ToUpper() == "TOBACCO USE AND EXPOSURE")
                        {
                            ...
                            XmlDocument docAllergyEntry = new XmlDocument();
                            docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\SocialHistoryTobacco.xml"));
                            XmlDocumentFragment xfragAllergy = xmlDoc.CreateDocumentFragment();
                            xfragAllergy.InnerXml = docAllergyEntry.DocumentElement.InnerXml;
                            elemOldentry.LastChild.AppendChild(xfragAllergy);
                            xmlDoc.Save(sPrintFileName);
                        ...
                        else if (ilstSocialHistory1[i].Social_Info.ToUpper() == "SMOKING HABIT")
                        {
                            ...
                            XmlDocument docAllergyEntry = new XmlDocument();
                            docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\SocialHistory.xml"));
                            XmlDocumentFragment xfragAllergy = xmlDoc.CreateDocumentFragment();
                            xfragAllergy.InnerXml = docAllergyEntry.DocumentElement.InnerXml;
                            elemOldentry.LastChild.AppendChild(xfragAllergy);
                            xmlDoc.Save(sPrintFileName);
            ...
            if (ClinicalSummary.Vitals != null && ClinicalSummary.Vitals.Count != 0 && hashCheckedList["chkVitals"] != null && hashCheckedList["chkVitals"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[27].ChildNodes[0].ChildNodes[3].InnerText.ToUpper() == "VITAL SIGNS")
                {
                    ...
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\VitalSign.xml"));
            ...
            //    XmlDocument docAllergyEntry = new XmlDocument();
            //    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), ("SampleXML" + "\\CognitiveFunction.xml"));
            ...
            //    XmlElement elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0];
            //    XmlDocument docAllergyEntry = new XmlDocument();
            //    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), ("SampleXML" + "\\CognitiveFunction_DP.xml"));
            ...
            if (ClinicalSummary.ImplantProcedure != null && ClinicalSummary.ImplantProcedure.Count != 0 && hashCheckedList["chkImplant"] != null && hashCheckedList["chkImplant"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[33].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "IMPLANTS")
                {
                    ...
                    XmlDocument docAllergyEntry = new XmlDocument();
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\Implant.xml"));
                    for (int i = 0; i < ClinicalSummary.ImplantProcedure.Count; i++)
                    {
            ...
            if (ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus != null && ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus.Count != 0 && hashCheckedList["chkMentalStatus"] != null && hashCheckedList["chkMentalStatus"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "MENTAL STATUS")
                {
                    ...
                    XmlDocument docAllergyEntry = new XmlDocument();
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\MentalStatus.xml"));
                    for (int i = 0; i < ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus.Count; i++)
                    {
            ...
            if (ClinicalSummary.Care_Plan_FunctionalStatus != null && ClinicalSummary.Care_Plan_FunctionalStatus.Count != 0 && hashCheckedList["chkFunctionalStatus"] != null && hashCheckedList["chkFunctionalStatus"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[37].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "FUNCTIONAL STATUS")
                {
                    ...
                    XmlDocument docAllergyEntry = new XmlDocument();
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\FunctionalStatus.xml"));
                    for (int i = 0; i < ClinicalSummary.Care_Plan_FunctionalStatus.Count; i++)
                    {
            ...
            if (ClinicalSummary.TreatmentPlan != null && ClinicalSummary.TreatmentPlan.Count != 0 && hashCheckedList["chkGoals"] != null && hashCheckedList["chkGoals"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[39].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "GOALS SECTION")
                {
                    ...
                    XmlDocument docAllergyEntry = new XmlDocument();
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\Goals.xml"));
                    for (int i = 0; i < ClinicalSummary.TreatmentPlan.Count; i++)
                    {
            ...
            if (ClinicalSummary.HealthConcernProblemList != null && ClinicalSummary.HealthConcernProblemList.Count != 0 && hashCheckedList["chkHealthConcern"] != null && hashCheckedList["chkHealthConcern"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[41].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "HEALTH CONCERNS SECTION")
                {
                    ...
                    XmlDocument docAllergyEntry = new XmlDocument();
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\HealthConcern.xml"));
                    for (int i = 0; i < ClinicalSummary.HealthConcernProblemList.Count; i++)
                    {
                        XmlDocumentFragment xfragAllergy = xmlDoc.CreateDocumentFragment();
                        xfragAllergy.InnerXml = docAllergyEntry.DocumentElement.InnerXml;
            ...
            if (ClinicalSummary.OthertreatmentPlan != null && ClinicalSummary.OthertreatmentPlan.Count != 0 && hashCheckedList["chkTreatmentPlan"] != null && hashCheckedList["chkTreatmentPlan"].ToString().ToUpper() == "TRUE")
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[43].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "TREATMENT PLAN")
                {
                    ...
                    XmlDocument docAllergyEntry = new XmlDocument();
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML" + "\\TreatmentPlan.xml"));
                    //docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), ("SampleXML" + "\\TreatmentPlan.xml"));
                    for (int i = 0; i < ClinicalSummary.OthertreatmentPlan.Count; i++)
                    {
        ...
        //                    //sInnerXML += "<tr><td>" + ClinicalSummary.Allergy[i].Allergy_Name + ", " + ClinicalSummary.Allergy[i].Rxnorm_ID + "</td><td>" + ClinicalSummary.Allergy[i].Reaction + "</td><td></td><td>Active</td></tr>";
        //                    sInnerXML += "<tr><td>" + ClinicalSummary.Allergy[i].Allergy_Name + ", " + response + "</td><td>" + ClinicalSummary.Allergy[i].Reaction + "</td><td></td><td>Active</td></tr>";
        //                    if (i == ClinicalSummary.Allergy.Count - 1)
        //                    {
        //                        sInnerXML += "</tbody>";
        ...
        //                        sInnerXML = "<tbody xmlns=" + '"' + "urn:hl7-org:v3" + '"' + ">";
        //                    }
        //                    string strValue = (ClinicalSummary.EncounterDiagnosis.Count > 0) ? ClinicalSummary.EncounterDiagnosis[0].Snomed_Code_Description + "," + ClinicalSummary.EncounterDiagnosis[0].Snomed_Code : "";
        //                    sInnerXML += "<tr><td>" + strValue + "</td><td>" + Phy.PhyLastName + "," + Phy.PhyFirstName + "</td><td>" + ClinicalSummary.Encounter[i].Facility_Name + "</td><td>" + ClinicalSummary.Encounter[i].Date_of_Service.ToString("MMMM dd,yyyy") + "</td></tr>";
        //                    if (i == ClinicalSummary.Encounter.Count - 1)
        //                    {
        //                        sInnerXML += "</tbody>";
        ...
        //                    }
        //                    if (sdate != "")
        //                        sInnerXML += "<tr><td>" + ClinicalSummary.immunhistoryList[i].Immunization_Description + " CVX:" + ClinicalSummary.immunhistoryList[i].CVX_Code + "</td><td>" + dtAdministrativedate.ToString("MMMM dd,yyyy") + "</td><td>" + "Completed" + "</td></tr>";
        //                    else
        //                    {
        //                        sInnerXML += "<tr><td>" + ClinicalSummary.immunhistoryList[i].Immunization_Description + " CVX:" + ClinicalSummary.immunhistoryList[i].CVX_Code + "</td><td>" + "</td><td>" + "Completed" + "</td></tr>";
        //                    }
        //                    if (i == ClinicalSummary.immunhistoryList.Count - 1)
        //                    {
        //                        sInnerXML += "</tbody>";
        ...
        //                    // sInnerXML += "<tr><td><content ID='" + "Med" + i.ToString() + "'>" + ClinicalSummary.Medication[i].Generic_Name + " (" + ClinicalSummary.Medication[i].Rxnorm_ID + ")" + "</content></td><td>" + ClinicalSummary.Medication[i].Strength + " " + ClinicalSummary.Medication[i].Action + " " + ClinicalSummary.Medication[i].Dose + " " + ClinicalSummary.Medication[i].Dose_Unit + " " + ClinicalSummary.Medication[i].Dose_Timing + " " + ClinicalSummary.Medication[i].Patient_Notes + "</td><td>" + ClinicalSummary.Medication[i].Start_Date.ToString("yyyyMMdd") + "</td><td>" + ClinicalSummary.Medication[i].Stop_Date.ToString("yyyyMMdd") + "</td><td>" + "Active" + "</td><td>" + sIndication + "</td><td>" + ClinicalSummary.Medication[i].Comments + "</td></tr>";
        //                    sInnerXML += "<tr><td><content ID='" + "Med" + i.ToString() + "'>" + ClinicalSummary.Medication[i].Generic_Name + " " + ClinicalSummary.Medication[i].Strength + "</content></td><td>" + ClinicalSummary.Medication[i].Action + " " + ClinicalSummary.Medication[i].Dose + " " + ClinicalSummary.Medication[i].Dose_Unit + " " + ClinicalSummary.Medication[i].Dose_Timing + " " + ClinicalSummary.Medication[i].Dose_Other + " " + ClinicalSummary.Medication[i].Patient_Notes + "</td><td>" + ClinicalSummary.Medication[i].Start_Date.ToString("MMMM dd,yyyy") + "</td></tr>";
        ...
        //                {
        //                    if (ClinicalSummary.ProblemListing[i].Date_Diagnosed != "")
        //                        sInnerXML += "<item xmlns=" + '"' + "urn:hl7-org:v3" + '"' + "><content ID='" + "problem" + i.ToString() + "'>" + ClinicalSummary.ProblemListing[i].Snomed_Code_Description + "," + ClinicalSummary.ProblemListing[i].Snomed_Code + ",Status - " + ClinicalSummary.ProblemListing[i].Status + "," + ClinicalSummary.ProblemListing[i].Date_Diagnosed + "</content></item>";
        //                    else
        //                        sInnerXML += "<item xmlns=" + '"' + "urn:hl7-org:v3" + '"' + "><content ID='" + "problem" + i.ToString() + "'>" + ClinicalSummary.ProblemListing[i].Snomed_Code_Description + "," + ClinicalSummary.ProblemListing[i].Snomed_Code + ",Status - " + ClinicalSummary.ProblemListing[i].Status + "</content></item>";
        //                }
        //            }
        //            else
        //            {
        ...
        //                    sInnerXML += "<tr><td>" + ClinicalSummary.laborderList[i].labProcedureDescription.Lab_Procedure_Description + " (" + ClinicalSummary.laborderList[i].labProcedureDescription.Lab_Procedure + ")" + "</td><td>" + ClinicalSummary.laborderList[i].labProcedureDescription.Created_Date_And_Time.ToString("MMMM dd,yyyy") + "</td></tr>";
        //                    if (i == ClinicalSummary.laborderList.Count - 1)
        //                    {
        //                        sInnerXML += "</tbody>";
        //                    }
        ...
        //    if (ClinicalSummary.ResultList != null && ClinicalSummary.ResultList.Count != 0 && hashCheckedList["chkLaboratoryResultValues"] != null && hashCheckedList["chkLaboratoryResultValues"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[19].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "RESULTS")
        //        {
        ...
        //                    // sInnerXML += "<tr><td>" + ClinicalSummary.ResultList[i].OBX_Observation_Text + "," + ClinicalSummary.ResultList[i].OBX_Observation_Identifier + " " + ClinicalSummary.ResultList[i].Created_Date_And_Time.ToString("yyyyMMdd") + "</td><td>" + ClinicalSummary.ResultList[i].OBX_Observation_Value + " " + ClinicalSummary.ResultList[i].OBX_Units + "</td></tr>";
        //                    //ClinicalSummary.ResultList[i].temp_property= value from "Result_Review_Comments" column from result_master table 
        //                    sInnerXML += "<tr><td>" + ClinicalSummary.ResultList[i].OBX_Observation_Text + "," + ClinicalSummary.ResultList[i].OBX_Observation_Identifier + "</td><td>" + ClinicalSummary.ResultList[i].OBX_Observation_Value + " " + ClinicalSummary.ResultList[i].OBX_Units + "</td><td>" + ClinicalSummary.ResultList[i].OBX_Reference_Range + "</td><td>" + ClinicalSummary.ResultList[i].OBX_Value_Type + "</td><td>" + ClinicalSummary.ResultList[i].Created_Date_And_Time.ToString("MMMM dd,yyyy") + "</td></tr>";
        //                    if (i == ClinicalSummary.ResultList.Count - 1)
        //                    {
        //                        sInnerXML += "</tbody>";
        //                    }
        ...
        //            XmlElement elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[19];
        ...
        //                elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[19];
        ...
        //                elemLonicIdentifierobservation = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[19].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[3];
        //                elemLonicIdentifierobservation.Attributes[1].Value = ClinicalSummary.ResultList[i].OBX_Observation_Identifier.ToString();
        //                elemLonicIdentifierobservation.Attributes[4].Value = ClinicalSummary.ResultList[i].OBX_Observation_Text.ToString();
        //                //elemreference = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[17].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[3].ChildNodes[0];
        //                //elemreference.InnerText = "";
        //                elemResultCaptureDatetime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[19].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[6];
        //                //string sResult = "Result";
        //                //if (ClinicalSummary.ResultList[i]. == "Result")
        //                elemResultCaptureDatetime.Attributes[0].Value = ClinicalSummary.ResultList[i].Created_Date_And_Time.ToString("yyyyMMdd");//PatientResultcaptureddatetime

        //                elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[19].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[7];


        //                if (Regex.IsMatch(ClinicalSummary.ResultList[i].OBX_Observation_Value.Replace(" ", ""), @"^[a-zA-Z]+$"))
        //                {
        //                    elemValue.InnerText = ClinicalSummary.ResultList[i].OBX_Observation_Value.ToString();
        //                    elemValue.Attributes[0].Value = "ST";
        //                    elemValue.RemoveAttribute("value");
        //                    elemValue.RemoveAttribute("unit");
        //                }
        //                else
        //                {
        //                    elemValue.Attributes[1].Value = ClinicalSummary.ResultList[i].OBX_Observation_Value.ToString();
        //                }

        //                if (elemValue.Attributes.Count > 2)
        //                {
        //                    if (ClinicalSummary.ResultList[i].OBX_Units.ToString() != "")
        //                        elemValue.Attributes[2].Value = ClinicalSummary.ResultList[i].OBX_Units.ToString();
        //                    else
        //                        elemValue.RemoveAttribute("unit");
        //                }
        //            }
        ...
        //    if (ClinicalSummary.SocialHistory != null && ClinicalSummary.SocialHistory.Count != 0 && hashCheckedList["chkSmokingStatus"] != null && hashCheckedList["chkSmokingStatus"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "SOCIAL HISTORY")
        //        {
        ...
        //                    //sInnerXML += "<tr><td>" + ilstSocialHistory1[i].Social_Info.ToString() + "</td><td>" + ilstSocialHistory1[i].Value + "-" + ilstSocialHistory1[i].Description + "</td><td>" + ilstSocialHistory1[i].Recodes + "</td></tr>";
        //                    sInnerXML += "<tr><td>" + ilstSocialHistory1[i].Social_Info.ToString() + "</td><td>" + ilstSocialHistory1[i].Value + ", " + ilstSocialHistory1[i].Recodes + "</td><td>" + (ilstSocialHistory1[i].Modified_Date_And_Time.ToString("yyyyMMdd") != "00010101" ? ilstSocialHistory1[i].Modified_Date_And_Time.ToString("MMMM dd,yyyy") : ilstSocialHistory1[i].Created_Date_And_Time.ToString("MMMM dd,yyyy")) + "</td></tr>";
        ...
        //            XmlElement elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21];
        ...
        //                    elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21];
        //                    XmlElement eleDisplayName = null;
        //                    XmlElement eleLowTime = null;
        //                    XmlElement elemValue = null;

        //                    eleDisplayName = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[3];
        //                    eleDisplayName.Attributes[3].Value = ilstSocialHistory1[i].Social_Info;

        //                    eleLowTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0];
        //                    eleLowTime.Attributes[0].Value = ilstSocialHistory1[i].Modified_Date_And_Time.ToString("yyyyMMdd") != "00010101" ? ilstSocialHistory1[i].Modified_Date_And_Time.ToString("yyyyMMdd") : ilstSocialHistory1[i].Created_Date_And_Time.ToString("yyyyMMdd");

        //                    elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6];
        //                    elemValue.Attributes[1].Value = ilstSocialHistory1[i].Recodes.ToString();
        //                    elemValue.Attributes[2].Value = ilstSocialHistory1[i].Social_Info;
        ...
        //                    elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[5];
        //                    elemValue.Attributes[1].Value = ilstSocialHistory1[i].Recodes.ToString();
        //                    elemValue.Attributes[3].Value = ilstSocialHistory1[i].Social_Info;
        ...
        //    if (ClinicalSummary.Vitals != null && ClinicalSummary.Vitals.Count != 0 && hashCheckedList["chkVitals"] != null && hashCheckedList["chkVitals"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "VITAL SIGNS")
        //        {
        ...
        //            XmlElement elemDate1 = null;
        //            XmlElement elemDate2 = null;
        //            elemDate1 = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[3].ChildNodes[0].ChildNodes[0].ChildNodes[0].ChildNodes[1];
        //            // elemDate2 = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[3].ChildNodes[0].ChildNodes[0].ChildNodes[0].ChildNodes[2];
        //            elemDate1.InnerText = ilstPatientResult1[0].Captured_date_and_time.ToString("yyyy-MM-dd");
        //            //elemDate2.InnerText = ClinicalSummary.Vitals[0].Captured_date_and_time.ToString("yyyy-MM-dd");
        ...
        //                        ////sHeight = feet.ToString() + "Ft " + remainInch.ToString() + "Inch";
        //                        //sInnerXML += "<tr><th>" + ilstPatientResult1[i].Loinc_Observation + "</th><td>" + sHeight + "</td></tr>";
        //                        sInnerXML += "<tr><th>" + ilstPatientResult1[i].Loinc_Observation + "</th><td>" + heigntCM + " " + ilstPatientResult1[i].Units.ToString() + "</td></tr>";
        //                    }
        //                    else if (ilstPatientResult1[i].Loinc_Observation == "Weight")
        //                    {
        //                        Decimal weightKG = 0;
        ...
        //                        sInnerXML += "<tr><th>" + ilstPatientResult1[i].Loinc_Observation + "</th><td>" + weightKG + " " + ilstPatientResult1[i].Units.ToString() + "</td></tr>";
        //                    }
        //                    else
        //                        sInnerXML += "<tr><th>" + ilstPatientResult1[i].Loinc_Observation + "</th><td>" + ilstPatientResult1[i].Value.ToString() + " " + ilstPatientResult1[i].Units.ToString() + "</td></tr>";
        //                    if (i == ilstPatientResult1.Count - 1)
        //                    {
        //                        sInnerXML += "</tbody>";
        //                    }
        ...
        //                    elemVitalCapturedDateTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4];
        //                    if (ilstPatientResult1[i].Results_Type.ToString().ToUpper() == "VITALS")
        //                        elemVitalCapturedDateTime.Attributes[0].Value = ilstPatientResult1[i].Captured_date_and_time.ToString("yyyyMMdd");
        //                    elemCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[3];
        //                    string sLoincIdentifier = ilstPatientResult1[i].Loinc_Identifier;
        //                    if (sLoincIdentifier != string.Empty)
        //                        elemCode.Attributes[0].Value = sLoincIdentifier; //ClinicalSummary.Vitals[i].Loinc_Identifier;
        //                    else
        ...
        //                    //elemReference = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[3].ChildNodes[0];
        //                    //elemReference.Attributes[0].Value = "";
        //                    elemEffectiveTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[6];
        //                    if (ilstPatientResult1[i].Results_Type.ToString().ToUpper() == "VITALS")
        //                        elemEffectiveTime.Attributes[0].Value = ilstPatientResult1[i].Captured_date_and_time.ToString("yyyyMMdd");
        //                    elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[7];
        //                    string sValues = ilstPatientResult1[i].Value;
        ...
        //                            elemVitalCapturedDateTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + iArryCount].ChildNodes[0].ChildNodes[4];
        //                            if (ilstPatientResult1[i].Results_Type.ToString().ToUpper() == "VITALS")
        //                                elemVitalCapturedDateTime.Attributes[0].Value = ilstPatientResult1[i].Captured_date_and_time.ToString("yyyyMMdd");
        //                            elemCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + iArryCount].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[3];
        //                            string sLoincIdentifier = ilstPatientResult1[i].Loinc_Identifier;
        ...
        //                                elemCode.Attributes[3].Value = "BP Diastolic";
        //                            }
        //                            elemEffectiveTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + iArryCount].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[6];
        //                            if (ilstPatientResult1[i].Results_Type.ToString().ToUpper() == "VITALS")
        //                                elemEffectiveTime.Attributes[0].Value = ilstPatientResult1[i].Captured_date_and_time.ToString("yyyyMMdd");
        //                            elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + iArryCount].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[7];
        //                            string sValues = ilstPatientResult1[i].Value;
        //                            if (ilstPatientResult1[i].Loinc_Observation == "Height")
        //                            {
        //                                if (sValues == string.Empty)
        ...
        //    if (ClinicalSummary.Encounter != null && ClinicalSummary.Encounter.Count != 0 && hashCheckedList["chkClinicalInstruction"] != null && hashCheckedList["chkClinicalInstruction"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[25].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "INSTRUCTIONS")
        //        {
        ...
        //        xAttribute.Value = "NI";
        //        xelemSection.Attributes.Append(xAttribute);
        //        XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[25].ChildNodes[0].ChildNodes[3];
        //        elemOld.RemoveAll();
        //        elemOld.InnerText = "No known data found";
        //        //XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
        //        //string sInnerXML = string.Empty;
        ...
        //    if (ClinicalSummary.ChiefComplaints != null && ClinicalSummary.ChiefComplaints.Count != 0 && hashCheckedList["chkChiefComplaints"] != null && hashCheckedList["chkChiefComplaints"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[27].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "ASSESSMENTS")
        //        {

        //            XmlElement elemChiefText = null;
        //            elemChiefText = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[27].ChildNodes[0].ChildNodes[3];
        //            // string hpi_element = "chief complaints";
        //            string sAssessmentText = string.Empty;
        //            string startTime = ClinicalSummary.Birth_Date.ToString();
        ...
        //        XmlAttribute xAttribute = xelemSection.OwnerDocument.CreateAttribute("nullFlavor");
        //        xAttribute.Value = "NI";
        //        XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[27].ChildNodes[0].ChildNodes[3];
        //        elemOld.RemoveAll();
        //        elemOld.InnerText = "No known data found";
        //        //XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
        //        //string sInnerXML = string.Empty;
        ...
        //    if (ClinicalSummary.ImplantProcedure != null && ClinicalSummary.ImplantProcedure.Count != 0 && hashCheckedList["chkImplant"] != null && hashCheckedList["chkImplant"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "IMPLANTS")
        //        {
        //            XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29].ChildNodes[0].ChildNodes[3];
        //            XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
        //            string sInnerXML = string.Empty;
        ...
        //                    if (ClinicalSummary.ImplantProcedure[i].Device_Identifier_UDI.Trim() != "" || ClinicalSummary.ImplantProcedure[i].Device_Identifier_DI.Trim() != "")
        //                        if (ClinicalSummary.ImplantProcedure[i].Device_Identifier_UDI.Trim() != "")
        //                            sInnerXML += "<tr><td>" + ClinicalSummary.ImplantProcedure[i].GMDN_PT_Name + "</td><td></td><td>" + ClinicalSummary.ImplantProcedure[i].Device_Identifier_UDI + "</td></tr>";
        //                        else
        //                            sInnerXML += "<tr><td>" + ClinicalSummary.ImplantProcedure[i].GMDN_PT_Name + "</td><td></td><td>" + ClinicalSummary.ImplantProcedure[i].Device_Identifier_DI + "</td></tr>";
        //                    if (i == ClinicalSummary.ImplantProcedure.Count - 1)
        //                    {
        //                        sInnerXML += "</tbody>";
        //                    }
        ...
        //            XmlElement elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29];
        //            XmlDocument docAllergyEntry = new XmlDocument();
        //            docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Implant.xml"));
        //            for (int i = 0; i < ClinicalSummary.ImplantProcedure.Count; i++)
        //            {
        ...
        //                xmlDoc.Save(sPrintFileName);
        //                xmlDoc.Load(sPrintFileName);
        //                elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29];
        ...
        //                elemCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[2];
        //                elemlow = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[1];
        //                // elemTargetSite = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6];
        //                elemlow.Attributes[0].Value = Convert.ToDateTime(ClinicalSummary.ImplantProcedure[i].Created_Date_And_Time).ToString("yyyyMMdd");
        //                elemextension = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[7].ChildNodes[0].ChildNodes[7];
        //                elemGMPTName = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[7].ChildNodes[0].ChildNodes[8].ChildNodes[1];
        //                if (ClinicalSummary.ImplantProcedure[i].Device_Identifier_UDI.Trim() != "")
        //                {
        //                    elemextension.Attributes[1].Value = ClinicalSummary.ImplantProcedure[i].Device_Identifier_UDI;
        //                    elemGMPTName.Attributes[0].Value = ClinicalSummary.ImplantProcedure[i].Device_Identifier_UDI;
        ...
        //    else if (hashCheckedList["chkImplant"] != null && hashCheckedList["chkImplant"].ToString().ToUpper() == "FALSE")
        //    {
        //        XmlElement xBookParticipant = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[29].ChildNodes[0];
        //        XmlAttribute xAttribute = xBookParticipant.OwnerDocument.CreateAttribute("nullFlavor");
        //        xAttribute.Value = "NI";
        //        xBookParticipant.Attributes.Append(xAttribute);
        ...
        //    if (ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus != null && ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus.Count != 0 && hashCheckedList["chkMentalStatus"] != null && hashCheckedList["chkMentalStatus"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[31].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "MENTAL STATUS")
        //        {
        //            XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[31].ChildNodes[0].ChildNodes[3];
        //            XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
        //            string sInnerXML = string.Empty;
        ...
        //            XmlElement elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[31];
        //            XmlDocument docAllergyEntry = new XmlDocument();
        //            docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\MentalStatus.xml"));
        //            for (int i = 0; i < ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus.Count; i++)
        //            {
        ...
        //                elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[31];
        ...
        //                eEffectiveTimeLow = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[31].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0];
        //                if (ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus[i].Plan_Date.Trim() != "")
        //                    eEffectiveTimeLow.Attributes[0].Value = Convert.ToDateTime(ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus[i].Plan_Date).ToString("yyyyMMdd");
        //                eCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[31].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6];
        //                eCode.Attributes[1].Value = ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus[i].Snomed_Code;
        //                eDisplayName = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[31].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6];
        //                eDisplayName.Attributes[2].Value = ClinicalSummary.Care_Plan_Cognitive_Function_MentalStatus[i].Care_Name_Value;
        ...
        //    else if (hashCheckedList["chkMentalStatus"] != null && hashCheckedList["chkMentalStatus"].ToString().ToUpper() == "FALSE")
        //    {
        //        XmlElement xBookParticipant = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[31].ChildNodes[0];
        //        XmlAttribute xAttribute = xBookParticipant.OwnerDocument.CreateAttribute("nullFlavor");
        //        xAttribute.Value = "NI";
        //        xBookParticipant.Attributes.Append(xAttribute);
        ...
        //    if (ClinicalSummary.Care_Plan_FunctionalStatus != null && ClinicalSummary.Care_Plan_FunctionalStatus.Count != 0 && hashCheckedList["chkFunctionalStatus"] != null && hashCheckedList["chkFunctionalStatus"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[33].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "FUNCTIONAL STATUS")
        //        {
        //            XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[33].ChildNodes[0].ChildNodes[3];
        //            XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
        //            string sInnerXML = string.Empty;
        ...
        //                XmlElement eDisplayName = null;
        //                XmlElement eEffectiveTime1 = null;
        //                eReference = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[33].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[3].ChildNodes[0];
        //                eReference.Attributes[0].Value = "#FUNC" + i + 1;//ClinicalSummary.Care_Plan_FunctionalStatus[i].Care_Name_Value;
        //                eEffectiveTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[33].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[5];
        //                if (ClinicalSummary.Care_Plan_FunctionalStatus[i].Plan_Date.Trim() != "")
        //                    eEffectiveTime.Attributes[0].Value = Convert.ToDateTime(ClinicalSummary.Care_Plan_FunctionalStatus[i].Plan_Date).ToString("yyyyMMdd");
        //                eCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[33].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[6];
        //                eCode.Attributes[1].Value = ClinicalSummary.Care_Plan_FunctionalStatus[i].Snomed_Code;
        //                eDisplayName = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[33].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[6];
        //                eDisplayName.Attributes[2].Value = ClinicalSummary.Care_Plan_FunctionalStatus[i].Care_Name_Value;
        //                eEffectiveTime1 = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[33].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[4];
        //                if (ClinicalSummary.Care_Plan_FunctionalStatus[i].Plan_Date.Trim() != "")
        //                    eEffectiveTime1.Attributes[0].Value = Convert.ToDateTime(ClinicalSummary.Care_Plan_FunctionalStatus[i].Plan_Date).ToString("yyyyMMdd");
        //            }
        //        }
        ...
        //    if (ClinicalSummary.TreatmentPlan != null && ClinicalSummary.TreatmentPlan.Count != 0 && hashCheckedList["chkGoals"] != null && hashCheckedList["chkGoals"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "GOALS SECTION")
        //        {
        //            XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[3];
        //            XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
        //            string sInnerXML = string.Empty;
        ...
        //                eEffectiveTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4];
        //                eEffectiveTime.Attributes[0].Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
        //                ePlanGoal = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5];
        //                ePlanGoal.InnerText = ClinicalSummary.TreatmentPlan[i].Plan.Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("'", "&apos;").Replace("\"", "&quot;");
        //                eTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6].ChildNodes[1];
        //                eTime.Attributes[0].Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
        //                eSpecialityNPI = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6].ChildNodes[2].ChildNodes[1];
        //                eSpecialityNPI.Attributes[1].Value = ClinicalSummary.phyList[0].Taxonomy_Description.Replace("&", "&amp;");
        //                //if (Phy.PhyColor.Trim() != string.Empty)
        //                //    eSpecialityNPI.Attributes[0].Value = Phy.PhyColor.Split('-')[0];
        //                eSpeciality = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6].ChildNodes[2].ChildNodes[1];
        //                eSpecialityNPI.Attributes[0].Value = ClinicalSummary.phyList[0].Taxonomy_Code;
        //                //if (Phy.PhyColor.Trim() != string.Empty)
        //                //    eSpeciality.Attributes[1].Value = Phy.PhyColor.Split('-')[1];
        ...
        //                egiven = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6].ChildNodes[2].ChildNodes[2].ChildNodes[0].ChildNodes[0];
        //                egiven.InnerText = Phy.PhyFirstName;
        //                eFamily = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6].ChildNodes[2].ChildNodes[2].ChildNodes[0].ChildNodes[1];
        //                eFamily.InnerText = Phy.PhyLastName;
        //                eSuffix = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[6].ChildNodes[2].ChildNodes[2].ChildNodes[0].ChildNodes[2];
        //                eSuffix.InnerText = Phy.PhySuffix;




        //                AssignedAuthor = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[35].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[7].ChildNodes[2].ChildNodes[0];
        //                if (ClinicalSummary.PhysicianLibraryDocumentation.Count > 0 && ClinicalSummary.PhysicianLibraryDocumentation[0].Physician_SSN_Number.Trim() != "")
        //                {
        //                    AssignedAuthor.Attributes[0].Value = ClinicalSummary.PhysicianLibraryDocumentation[0].Physician_SSN_Number;
        //                }
        ...
        //    if (ClinicalSummary.HealthConcernProblemList != null && ClinicalSummary.HealthConcernProblemList.Count != 0 && hashCheckedList["chkHealthConcern"] != null && hashCheckedList["chkHealthConcern"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[37].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "HEALTH CONCERNS SECTION")
        //        {
        //            XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[37].ChildNodes[0].ChildNodes[3];
        //            XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
        //            string sInnerXML = string.Empty;
        ...
        //                            if (ass.Count > 0)
        //                            {
        //                                sInnerXML += "<tr><td>Chronic Sickness exhibited by patient</td></tr>";
        //                            }
        //                        }
        ...
        //    if (ClinicalSummary.OthertreatmentPlan != null && ClinicalSummary.OthertreatmentPlan.Count != 0 && hashCheckedList["chkTreatmentPlan"] != null && hashCheckedList["chkTreatmentPlan"].ToString().ToUpper() == "TRUE")
        //    {
        //        if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[39].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "TREATMENT PLAN")
        //        {
        //            XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[39].ChildNodes[0].ChildNodes[3];
        //            XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
        //            string sInnerXML = string.Empty;
        ...
        //                elemPlanName = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[39].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[4];
        //                if (ClinicalSummary.OthertreatmentPlan[i].Plan_For_Plan.Trim() != "")
        //                    elemPlanName.Attributes[3].Value = ClinicalSummary.OthertreatmentPlan[i].Plan.Replace("&#xD;&#xA;", "").Replace("&#xA;", " ").Replace("&#xD;", " ").Replace("\r\n", "").Replace("\n", "").Replace("\r", "").Replace("-Vitals", "").Replace("-Problem List", "").Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("'", "&apos;").Replace("\"", "&quot;") + " - " + ClinicalSummary.OthertreatmentPlan[i].Plan_For_Plan.Replace("&#xD;&#xA;", "").Replace("&#xA;", " ").Replace("&#xD;", " ").Replace("\r\n", "").Replace("\n", "").Replace("\r", "");
        //                else
        //                    elemPlanName.Attributes[3].Value = ClinicalSummary.OthertreatmentPlan[i].Plan.Replace("&#xD;&#xA;", "").Replace("&#xA;", " ").Replace("&#xD;", " ").Replace("\r\n", "").Replace("\n", "").Replace("\r", "").Replace("-Vitals", "").Replace("-Problem List", "").Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("'", "&apos;").Replace("\"", "&quot;");
        //                elemelemdate = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[39].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[7];
        //                elemelemdate.Attributes[0].Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
        //            }
        //        }
        //    }
        ...
        public string CreateImmunizationRegistryNIST(Human hn, PhysicianLibrary Phy, FillClinicalSummary ClinicalSummary, string sPrintFileName)
        {
            ...
            if (EthnicityIdentifier == string.Empty)
            {
                sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^ACUR^MR||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L|" + hn.Mothers_Maiden_Name + "^^^^^^M|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "||" + RaceIdentifier + "^" + hn.Race + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||";
            }
            else
            {
                if (hn.EMail == string.Empty)
                    sResult = sResult + "\n" + "PID|1||" + hn.Id + "^^^ACUR^MR||" + hn.Last_Name + "^" + hn.First_Name + "^" + hn.MI + "^^^^L|" + hn.Mothers_Maiden_Name + "^^^^^^M|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Sex.Substring(0, 1) + "||" + RaceIdentifier + "^" + hn.Race + "^CDCREC|" + hn.Street_Address1 + "^^" + hn.City + "^" + hn.State + "^" + hn.ZipCode + "^USA^P||^PRN^PH^^^" + CityCode + "^" + LocalNumber + "|||||||||" + EthnicityIdentifier + "^" + hn.Ethnicity + "^CDCREC" + "||" + hn.Birth_Indicator + "|" + hn.Birth_Order + "|||||" + sDeathIndicator;
                else
            ...
            string sImmunizationProtectionIndicator = string.Empty;//Check
            if (PublicitycodeIdentifier != string.Empty && hn.Immunization_Registry_Status != string.Empty)
            {
                sResult = sResult + "\n" + "PD1|||||||||||" + PublicitycodeIdentifier + "^" + hn.Publicity_Code + "^HL70215|" + hn.Data_Sharing_Preference + "|" + hn.Created_Date_And_Time.ToString("yyyyMMdd") + "|||" + hn.Immunization_Registry_Status.Substring(0, 1) + "|" + hn.Birth_Date.ToString("yyyyMMdd") + "|" + hn.Created_Date_And_Time.ToString("yyyyMMdd");
            }
            else
            {
                sResult = sResult + "\n" + "PD1||||||||||||N||||||";
            ...
            if (ClinicalSummary.ImmunizationList != null && ClinicalSummary.ImmunizationList.Count > 0)
            {
                ...
                for (int i = 0; i < ClinicalSummary.ImmunizationList.Count; i++)
                {
                    ...
                    if (PhyLastName != string.Empty || PhyLastName != string.Empty || PhyLastName != string.Empty)
                    {
                        ...
                        if (ClinicalSummary.ImmunizationList[i].Modified_Date_And_Time.ToString("yyyy-MM-dd hh:mm:ss") == "0001-01-01 00:00:00")
                            sCurd = "U";
                        else
                            sCurd = "A";
                        if (ClinicalSummary.ImmunizationList[i].Is_Administration_Refused.ToUpper() != "Y")
                    ...
                    if (ClinicalSummary.ImmunizationList[i].Is_Administration_Refused.ToUpper() != "Y" && ClinicalSummary.ImmunizationList[i].Immunization_Evidence == string.Empty && VISList.Count > 0)
                    {
                        ...
                        sResult = sResult + "\n" + "OBX|1|CE|30963-3^Vaccine Funding Source^LN|1|VXC50^Public^CDCPHINVS||||||F|||" + ClinicalSummary.ImmunizationList[i].Given_Date.ToString("yyyyMMdd");
                        sResult = sResult + "\n" + "OBX|2|CE|64994-7^Vaccine funding program eligibility category^LN^|2|" + Vfc + "^" + ClinicalSummary.ImmunizationList[i].Vfc + "^HL70064||||||F|||" + ClinicalSummary.ImmunizationList[i].Given_Date.ToString("yyyyMMdd") + "|||VXC40^" + "Eligibility captured at the" + ClinicalSummary.ImmunizationList[i].Eligibility_Captured + "^CDCPHINVS";
            ...
            var ImmunizationHistoryList = (from p in ClinicalSummary.immunhistoryList where !ClinicalSummary.ImmunizationList.Any(i => i.Encounter_Id == p.Encounter_ID && (i.Given_Date).ToString("yyyy-MM-dd") == Convert.ToDateTime(p.Administered_Date).ToString("yyyy-MM-dd") && i.Procedure_Code == p.Procedure_Code) select p).ToList();
            if (ImmunizationHistoryList.Count > 0)
            {
                for (int i = 0; i < ImmunizationHistoryList.Count; i++)
                {
                    sResult = sResult + "\n" + "ORC|RE||" + ImmunizationHistoryList[i].Id + "^CAA|||||||" + sPhy_ID + "^" + PhyFirstName + "^" + PhyLastName + "^" + PhyMIName + "^^^^^CA-AA-1^L^^^PRN||" + "|||||" + sMSH6 + "^" + sMSH6 + "^HL70362|";

                    sResult = sResult + "\n" + "RXA|" + "0|1|" + Convert.ToDateTime(ImmunizationHistoryList[i].Administered_Date).ToString("yyyyMMdd") + "||"
        ...
        public string CreateHL7ForSyndromicSurveillance(Encounter objEncounter, Human objHuman, FacilityLibrary objFacility, FillClinicalSummary ClinicalSummary, string sMSH, string sACK)
        {
            ...
            if (sMSH == "ADT^A03^ADT_A03")
            {
                ...
                if (ClinicalSummary.HospitalizationHistory[0].To_Date != "" && ClinicalSummary.HospitalizationHistory[0].To_Date != "Current")
                {
                    ...
                    {
                        string sLookupXmlFilePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\staticlookup.xml");//HimajaPath.Combine(System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath, "ConfigXML\\staticlookup.xml");
        ...
        public XmlDocument GenerateCaseReportingXML(PhysicianLibrary Phy, FillClinicalSummary ClinicalSummary, string sPrintFileName)
        {
            XmlDocument xmlDoc = new XmlDocument();
            XmlDocument xmlRef = new XmlDocument();
            xmlDoc.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\CDA_Case_Reporting_Sample.xml"));
            XmlNodeList xmlReqNode = null;
            string sContent = string.Empty;
            ...
            #region PatientRole
            xmlReqNode = xmlDoc.GetElementsByTagName("patientRole");
            xmlReqNode[0].ChildNodes[1].ChildNodes[0].InnerText = ClinicalSummary.Street_Address1;
            xmlReqNode[0].ChildNodes[1].ChildNodes[1].InnerText = ClinicalSummary.City;
            xmlReqNode[0].ChildNodes[1].ChildNodes[2].InnerText = ClinicalSummary.State;
            xmlReqNode[0].ChildNodes[1].ChildNodes[3].InnerText = ClinicalSummary.ZipCode;
            if (ClinicalSummary.State != string.Empty && ClinicalSummary.City != string.Empty)
            {
                IList<State> state = new List<State>();
                state = objCounty.GetCountybyStateAndCity(ClinicalSummary.State, ClinicalSummary.City);
                if (state.Count > 0)
                    xmlReqNode[0].ChildNodes[1].ChildNodes[4].InnerText = state[0].County;
            }
            xmlReqNode[0].ChildNodes[1].ChildNodes[5].InnerText = "US";


            xmlReqNode = xmlDoc.GetElementsByTagName("telecom");
            string sTelephoneno = ClinicalSummary.Home_Phone_No;
            if (sTelephoneno != string.Empty)
                xmlReqNode[0].Attributes[1].Value = "tel:" + sTelephoneno;
            else
                xmlReqNode[0].Attributes[1].Value = "tel:" + "(111) 111-1111";

            xmlReqNode = xmlDoc.GetElementsByTagName("patient");
            xmlReqNode[0].ChildNodes[0].ChildNodes[0].InnerText = ClinicalSummary.HumanList[0].First_Name;
            xmlReqNode[0].ChildNodes[0].ChildNodes[1].InnerText = ClinicalSummary.HumanList[0].Last_Name;


            xmlReqNode = xmlDoc.GetElementsByTagName("administrativeGenderCode");
            if (ClinicalSummary.Sex != null && ClinicalSummary.Sex != string.Empty)
            {
                xmlReqNode[0].Attributes[0].Value = ClinicalSummary.HumanList[0].Sex.Substring(0, 1).ToUpper();
                xmlReqNode[0].Attributes[1].Value = ClinicalSummary.HumanList[0].Sex;
            }

            xmlReqNode = xmlDoc.GetElementsByTagName("birthTime");
            xmlReqNode[0].Attributes[0].Value = ClinicalSummary.HumanList[0].Birth_Date.ToString("yyyyMMdd");
            ...
            if (ClinicalSummary.lookupList != null)
            {
                for (int Race = 0; Race < ClinicalSummary.lookupList.Count; Race++)
                {
                    if (ClinicalSummary.lookupList[Race].Field_Name == "ETHNICITY")
                    {
                        xmlReqNode = xmlDoc.GetElementsByTagName("ethnicGroupCode");
                        xmlReqNode[0].Attributes[0].Value = ClinicalSummary.lookupList[Race].Default_Value.ToString();
                        xmlReqNode[0].Attributes[3].Value = ClinicalSummary.lookupList[Race].Value.ToString();
            ...
            #region guardian
            xmlReqNode = xmlDoc.GetElementsByTagName("guardian");
            if (ClinicalSummary.GuardianList.Count > 0)
            {
                if (ClinicalSummary.GuardianList.Count == 1)
                {
                    xmlReqNode[0].ChildNodes[1].ChildNodes[0].InnerText = ClinicalSummary.GuardianList[0].Street_Address1;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[1].InnerText = ClinicalSummary.GuardianList[0].City;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[2].InnerText = ClinicalSummary.GuardianList[0].State;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[3].InnerText = ClinicalSummary.GuardianList[0].ZipCode;
                    if (ClinicalSummary.GuardianList[0].State != string.Empty && ClinicalSummary.GuardianList[0].City != string.Empty)
                    {
                        IList<State> state = new List<State>();
                        state = objCounty.GetCountybyStateAndCity(ClinicalSummary.GuardianList[0].State, ClinicalSummary.GuardianList[0].City);
                        if (state.Count > 0)
                            xmlReqNode[0].ChildNodes[1].ChildNodes[4].InnerText = state[0].County;
                    }
                    xmlReqNode[0].ChildNodes[1].ChildNodes[5].InnerText = "US";

                    string sGuaTelephoneno = ClinicalSummary.GuardianList[0].Home_Phone_No;
                    if (sTelephoneno != string.Empty)
                        xmlReqNode[0].ChildNodes[3].Attributes[1].Value = "tel:" + sGuaTelephoneno;
                    else
                        xmlReqNode[0].ChildNodes[3].Attributes[1].Value = "tel:" + "(111) 111-1111";

                    if (ClinicalSummary.GuardianList[0].EMail != string.Empty)
                        xmlReqNode[0].ChildNodes[5].Attributes[0].Value = "mailto:" + ClinicalSummary.GuardianList[0].EMail;
                    else
                        xmlReqNode[0].ChildNodes[5].Attributes[0].Value = "mailto:mail@guardian.com";

                    xmlReqNode[0].ChildNodes[6].ChildNodes[0].ChildNodes[0].InnerText = ClinicalSummary.GuardianList[0].First_Name;
                    xmlReqNode[0].ChildNodes[6].ChildNodes[0].ChildNodes[1].InnerText = ClinicalSummary.GuardianList[0].Last_Name;
                }
                else if (ClinicalSummary.GuardianList.Count == 2)
                {
                    xmlReqNode[0].ChildNodes[1].ChildNodes[0].InnerText = ClinicalSummary.GuardianList[0].Street_Address1;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[1].InnerText = ClinicalSummary.GuardianList[0].City;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[2].InnerText = ClinicalSummary.GuardianList[0].State;
                    ...
                    //Second Guardian
                    xmlReqNode[1].ChildNodes[1].ChildNodes[0].InnerText = ClinicalSummary.GuardianList[1].Street_Address1;
                    xmlReqNode[1].ChildNodes[1].ChildNodes[1].InnerText = ClinicalSummary.GuardianList[1].City;
                    xmlReqNode[1].ChildNodes[1].ChildNodes[2].InnerText = ClinicalSummary.GuardianList[1].State;
                    xmlReqNode[1].ChildNodes[1].ChildNodes[3].InnerText = ClinicalSummary.GuardianList[1].ZipCode;
                    if (ClinicalSummary.GuardianList[1].State != string.Empty && ClinicalSummary.GuardianList[1].City != string.Empty)
                    {
                        IList<State> state = new List<State>();
                        state = objCounty.GetCountybyStateAndCity(ClinicalSummary.GuardianList[1].State, ClinicalSummary.GuardianList[1].City);
                        if (state.Count > 0)
                            xmlReqNode[1].ChildNodes[1].ChildNodes[4].InnerText = state[0].County;
                    }
                    xmlReqNode[1].ChildNodes[1].ChildNodes[5].InnerText = "US";


                    string sGua2Telephoneno = ClinicalSummary.GuardianList[1].Home_Phone_No;
                    if (sTelephoneno != string.Empty)
                        xmlReqNode[1].ChildNodes[3].Attributes[1].Value = "tel:" + sGua2Telephoneno;
                    else
                        xmlReqNode[1].ChildNodes[3].Attributes[1].Value = "tel:" + "(111) 111-1111";

                    if (ClinicalSummary.GuardianList[1].EMail != string.Empty)
                        xmlReqNode[1].ChildNodes[5].Attributes[0].Value = "mailto:" + ClinicalSummary.GuardianList[1].EMail;
                    else
                        xmlReqNode[1].ChildNodes[5].Attributes[0].Value = "mailto:mail@guardian.com";

                    xmlReqNode[1].ChildNodes[6].ChildNodes[0].ChildNodes[0].InnerText = ClinicalSummary.GuardianList[1].First_Name;
                    xmlReqNode[1].ChildNodes[6].ChildNodes[0].ChildNodes[1].InnerText = ClinicalSummary.GuardianList[1].Last_Name;
            ...
            xmlReqNode[0].ChildNodes[1].ChildNodes[0].InnerText = Phy.PhyAddress1;
            xmlReqNode[0].ChildNodes[1].ChildNodes[1].InnerText = Phy.PhyCity;
            xmlReqNode[0].ChildNodes[1].ChildNodes[2].InnerText = Phy.PhyState;
            xmlReqNode[0].ChildNodes[1].ChildNodes[3].InnerText = Phy.PhyZip;

            if (Phy.PhyState != string.Empty && Phy.PhyCity != string.Empty)
            {
                IList<State> state = new List<State>();
                state = objCounty.GetCountybyStateAndCity(Phy.PhyState, Phy.PhyCity);
                if (state.Count > 0)
                    xmlReqNode[0].ChildNodes[1].ChildNodes[4].InnerText = state[0].County;
            }
            xmlReqNode[0].ChildNodes[1].ChildNodes[5].InnerText = "US";
            ...
            string sphyTelephoneno = Phy.PhyTelephone;
            if (sphyTelephoneno != string.Empty)
                xmlReqNode[0].ChildNodes[2].Attributes[1].Value = "tel:" + sphyTelephoneno;
            else
                xmlReqNode[0].ChildNodes[2].Attributes[1].Value = "tel:" + "(909) 621-4949";
            #endregion

            #region custodian
            xmlReqNode = xmlDoc.GetElementsByTagName("representedCustodianOrganization");
            if (ClinicalSummary.Guarantor_human_MI == "" && (ClinicalSummary.Guarantor_human_Lastname != "" || ClinicalSummary.Guarantor_human_name != ""))
            {
                xmlReqNode[0].ChildNodes[2].InnerText = ClinicalSummary.Guarantor_human_Lastname + "," + ClinicalSummary.Guarantor_human_name;
            }
            else
            {
                xmlReqNode[0].ChildNodes[2].InnerText = ClinicalSummary.Guarantor_human_Lastname + "," + ClinicalSummary.Guarantor_human_name + ClinicalSummary.Guarantor_human_MI;
            }

            string sgurantorphoneno = ClinicalSummary.HumanList[0].Guarantor_Home_Phone_Number;
            if (sgurantorphoneno != string.Empty)
                xmlReqNode[0].ChildNodes[3].Attributes[1].Value = "tel:" + sgurantorphoneno;
            else
                xmlReqNode[0].ChildNodes[3].Attributes[1].Value = "tel:" + "(909) 621-4949";

            if (ClinicalSummary.facilityLibraryCustodian != null && ClinicalSummary.facilityLibraryCustodian.Count > 0)
            {
                for (int i = 0; i < ClinicalSummary.facilityLibraryCustodian.Count; i++)
                {
                    xmlReqNode[0].ChildNodes[4].ChildNodes[0].InnerText = ClinicalSummary.facilityLibraryCustodian[i].Fac_Address1;
                    xmlReqNode[0].ChildNodes[4].ChildNodes[1].InnerText = ClinicalSummary.facilityLibraryCustodian[i].Fac_City;
                    xmlReqNode[0].ChildNodes[4].ChildNodes[2].InnerText = ClinicalSummary.facilityLibraryCustodian[i].Fac_State;
                    xmlReqNode[0].ChildNodes[4].ChildNodes[3].InnerText = ClinicalSummary.facilityLibraryCustodian[i].Fac_Zip;
                    if (ClinicalSummary.facilityLibraryCustodian[i].Fac_State != string.Empty && ClinicalSummary.facilityLibraryCustodian[i].Fac_City != string.Empty)
                    {
                        IList<State> state = new List<State>();
                        state = objCounty.GetCountybyStateAndCity(ClinicalSummary.facilityLibraryCustodian[i].Fac_State, ClinicalSummary.facilityLibraryCustodian[i].Fac_City);
                        if (state.Count > 0)
                            xmlReqNode[0].ChildNodes[4].ChildNodes[4].InnerText = state[0].County;
                    }
                    xmlReqNode[0].ChildNodes[4].ChildNodes[5].InnerText = "US";
                }
            }
            #endregion

            #region documentationOf
            xmlReqNode = xmlDoc.GetElementsByTagName("encompassingEncounter");
            xmlReqNode[0].ChildNodes[1].Attributes[0].Value = ClinicalSummary.Encounter[0].Id.ToString();
            xmlReqNode[0].ChildNodes[4].ChildNodes[0].Attributes[0].Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
            xmlReqNode[0].ChildNodes[4].ChildNodes[1].Attributes[0].Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
            if (ClinicalSummary.PhysicianLibraryDocumentation != null && ClinicalSummary.PhysicianLibraryDocumentation.Count != 0)
            {
                for (int i = 0; i < ClinicalSummary.PhysicianLibraryDocumentation.Count; i++)
                {
                    xmlReqNode = xmlDoc.GetElementsByTagName("assignedEntity");
                    xmlReqNode[0].ChildNodes[1].ChildNodes[0].InnerText = Phy.PhyAddress1;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[1].InnerText = Phy.PhyCity;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[2].InnerText = Phy.PhyState;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[3].InnerText = Phy.PhyZip;
                    ...
                    if (sphyTelephoneno != string.Empty)
                        xmlReqNode[0].ChildNodes[3].Attributes[1].Value = "tel:" + sphyTelephoneno;
                    else
                        xmlReqNode[0].ChildNodes[3].Attributes[1].Value = "tel:" + "(909) 621-4949";
                    if (Phy.PhyFax != string.Empty)
                        xmlReqNode[0].ChildNodes[5].Attributes[1].Value = "fax:" + Phy.PhyFax;
                    else
                        xmlReqNode[0].ChildNodes[5].Attributes[1].Value = "fax:+1(555)555-1234";


                    if (Phy.PhyEMail != string.Empty)
                        xmlReqNode[0].ChildNodes[7].Attributes[1].Value = "mailto:" + Phy.PhyEMail;
                    else
                        xmlReqNode[0].ChildNodes[7].Attributes[1].Value = "mailto:mail@provider_domain.com";

                    xmlReqNode = xmlDoc.GetElementsByTagName("assignedPerson");
                    xmlReqNode[0].ChildNodes[1].ChildNodes[0].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyFirstName;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[1].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyLastName;
                    xmlReqNode[0].ChildNodes[1].ChildNodes[2].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhySuffix;

                    xmlReqNode = xmlDoc.GetElementsByTagName("representedOrganization");
                    xmlReqNode[0].ChildNodes[1].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_Name;
                    xmlReqNode[0].ChildNodes[3].ChildNodes[0].InnerText = Phy.PhyAddress1;
                    xmlReqNode[0].ChildNodes[3].ChildNodes[1].InnerText = Phy.PhyCity;
                    xmlReqNode[0].ChildNodes[3].ChildNodes[2].InnerText = Phy.PhyState;
                    xmlReqNode[0].ChildNodes[3].ChildNodes[3].InnerText = Phy.PhyZip;
                    if (Phy.PhyState != string.Empty && Phy.PhyCity != string.Empty)
                    {
                        IList<State> state = new List<State>();
                        state = objCounty.GetCountybyStateAndCity(Phy.PhyState, Phy.PhyCity);
                        if (state.Count > 0)
                            xmlReqNode[0].ChildNodes[3].ChildNodes[4].InnerText = state[0].County;
                    }
                    xmlReqNode[0].ChildNodes[3].ChildNodes[5].InnerText = "US";


                    xmlReqNode = xmlDoc.GetElementsByTagName("healthCareFacility");
                    if (ClinicalSummary.facilityLibraryCustodian.Count > 0)
                    {
                        if (ClinicalSummary.facilityLibraryCustodian[0].Fac_NPI != "")
                            xmlReqNode[0].ChildNodes[1].Attributes.GetNamedItem("id").Value = ClinicalSummary.facilityLibraryCustodian[0].Fac_NPI;

                        xmlReqNode[0].ChildNodes[5].ChildNodes[0].ChildNodes[0].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_Address1;
                        xmlReqNode[0].ChildNodes[5].ChildNodes[0].ChildNodes[1].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_City;
                        xmlReqNode[0].ChildNodes[5].ChildNodes[0].ChildNodes[2].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_State;
                        xmlReqNode[0].ChildNodes[5].ChildNodes[0].ChildNodes[3].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_Zip;
                        if (ClinicalSummary.facilityLibraryCustodian[0].Fac_State != string.Empty && ClinicalSummary.facilityLibraryCustodian[0].Fac_City != string.Empty)
                        {
                            IList<State> state = new List<State>();
                            state = objCounty.GetCountybyStateAndCity(ClinicalSummary.facilityLibraryCustodian[0].Fac_State, ClinicalSummary.facilityLibraryCustodian[0].Fac_City);
                            if (state.Count > 0)
                                xmlReqNode[0].ChildNodes[5].ChildNodes[0].ChildNodes[4].InnerText = state[0].County;
                        }
                        xmlReqNode[0].ChildNodes[5].ChildNodes[0].ChildNodes[5].InnerText = "US";

                        xmlReqNode = xmlDoc.GetElementsByTagName("serviceProviderOrganization");
                        xmlReqNode[0].ChildNodes[1].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_Name;
                        xmlReqNode[0].ChildNodes[3].Attributes[1].Value = "tel:" + ClinicalSummary.facilityLibraryCustodian[0].Fac_Telephone;
                        xmlReqNode[0].ChildNodes[5].Attributes[1].Value = "fax:" + ClinicalSummary.facilityLibraryCustodian[0].Fac_Fax;

                        xmlReqNode[0].ChildNodes[7].ChildNodes[0].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_Address1;
                        xmlReqNode[0].ChildNodes[7].ChildNodes[1].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_City;
                        xmlReqNode[0].ChildNodes[7].ChildNodes[2].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_State;
                        xmlReqNode[0].ChildNodes[7].ChildNodes[3].InnerText = ClinicalSummary.facilityLibraryCustodian[0].Fac_Zip;
                        if (ClinicalSummary.facilityLibraryCustodian[0].Fac_State != string.Empty && ClinicalSummary.facilityLibraryCustodian[0].Fac_City != string.Empty)
                        {
                            IList<State> state = new List<State>();
                            state = objCounty.GetCountybyStateAndCity(ClinicalSummary.facilityLibraryCustodian[0].Fac_State, ClinicalSummary.facilityLibraryCustodian[0].Fac_City);
                            if (state.Count > 0)
                                xmlReqNode[0].ChildNodes[7].ChildNodes[4].InnerText = state[0].County;
                        }
                        xmlReqNode[0].ChildNodes[7].ChildNodes[5].InnerText = "US";
                    }
                    break;
                }
            }
            ...
            if (ClinicalSummary.PhysicianLibraryDocumentation != null && ClinicalSummary.PhysicianLibraryDocumentation.Count != 0)
            {
                for (int i = 0; i < ClinicalSummary.PhysicianLibraryDocumentation.Count; i++)
                {
                    ...
                    xmlReqNode = xmlDoc.GetElementsByTagName("prefix");
                    xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[4].ChildNodes[0].ChildNodes[0].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyPrefix;

                    xmlReqNode = xmlDoc.GetElementsByTagName("given");
                    xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[4].ChildNodes[0].ChildNodes[1].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyFirstName;
                    xmlReqNode = xmlDoc.GetElementsByTagName("family");
                    xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[4].ChildNodes[0].ChildNodes[2].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyLastName;

                    xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[2].ChildNodes[0].InnerText = Phy.PhyAddress1;
                    xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[2].ChildNodes[1].InnerText = Phy.PhyCity;
                    xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[2].ChildNodes[2].InnerText = Phy.PhyState;
                    xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[2].ChildNodes[3].InnerText = Phy.PhyZip;

                    if (sphyTelephoneno != string.Empty)
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[3].Attributes[1].Value = "tel:" + sphyTelephoneno;
                    else
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[2].ChildNodes[1].ChildNodes[3].Attributes[1].Value = "tel:" + "(909) 621-4949";

                    if (ClinicalSummary.PhysicianLibraryDocumentation.Count == 1)
                    {
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[2].ChildNodes[0].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyAddress1;
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[2].ChildNodes[1].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyCity;
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[2].ChildNodes[2].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyState;
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[2].ChildNodes[3].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyZip;
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[3].Attributes[0].Value = "tel:" + ClinicalSummary.PhysicianLibraryDocumentation[i].PhyTelephone;
                        string sMedicalAssistant = string.Empty;
                        if (ClinicalSummary.PhysicianLibraryDocumentation[i].Med_Phy_Assistant == string.Empty)
                            sMedicalAssistant = "_";
                        else
                            sMedicalAssistant = ClinicalSummary.PhysicianLibraryDocumentation[i].Med_Phy_Assistant;
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[4].ChildNodes[0].ChildNodes[0].InnerText = sMedicalAssistant;
                    }
                    else
                    {
                        i += 1;
                        ...
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[2].ChildNodes[3].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyZip;
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[3].Attributes[0].Value = "tel:" + ClinicalSummary.PhysicianLibraryDocumentation[i].PhyTelephone;
                        xmlDoc.GetElementsByTagName("documentationOf")[0].ChildNodes[0].ChildNodes[3].ChildNodes[1].ChildNodes[4].ChildNodes[0].ChildNodes[0].InnerText = ClinicalSummary.PhysicianLibraryDocumentation[i].PhyPrefix + " " + ClinicalSummary.PhysicianLibraryDocumentation[i].PhyFirstName + " " + ClinicalSummary.PhysicianLibraryDocumentation[i].PhyLastName;
                    }
                    break;
                }
            }
            ...
            #region Encounter Section
            if (ClinicalSummary.Encounter != null && ClinicalSummary.Encounter.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[9].InnerText == "Encounters")
                {
                    XmlElement elemOldtblEncDtls = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[10].ChildNodes[0];
                    XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
                    string sInnerXML = string.Empty;
                    ...
                    for (int i = 0; i < ClinicalSummary.Encounter.Count; i++)
                    {
                        ...
                        sInnerXML += "<tr><td>" + "Office outpatient visit 15 minutes" + "</td><td>" + ClinicalSummary.Encounter[i].Date_of_Service.ToString("MMMM dd,yyyy") + "</td><td>" + "Urgent Care Center" + "</td></tr>";
                        if (i == ClinicalSummary.Encounter.Count - 1)
                        {
                            sInnerXML += "</tbody>";
                        }
                    ...
                    xfrag.InnerXml = sInnerXML.Replace("&", "&amp;");
                    elemOldtblEncDtls.AppendChild(xfrag);
                }

                if (ClinicalSummary.Case_Report_EncounterDiagnosis != null && ClinicalSummary.Case_Report_EncounterDiagnosis.Count > 0)
                {
                    StaticLookupManager staticLkupManager = new StaticLookupManager();
                    IList<StaticLookup> staticLkupLst = new List<StaticLookup>();
                    staticLkupLst = staticLkupManager.getStaticLookupByFieldName("CASE_REPORTING_HEADER").ToList<StaticLookup>();
                    string RCTC_OID = string.Empty;
                    string RCTC_Version = string.Empty;
                    if (staticLkupLst != null && staticLkupLst.Count > 0)
                    {
                        RCTC_OID = staticLkupLst[0].Value;
                        RCTC_Version = Convert.ToDateTime(staticLkupLst[0].Description.Split('$')[0]).ToString("dd/MM/yyyy");
                    }

                    XmlElement elemOldtblEncDiagDtls = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[10].ChildNodes[1];
                    XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
                    string sInnerXML = string.Empty;
                    string Diag_Type = string.Empty;
                    string Type = "Diagnosis";
                    for (int i = 0; i < ClinicalSummary.Case_Report_EncounterDiagnosis.Count; i++)
                    {
                        Diag_Type = ClinicalSummary.Case_Report_EncounterDiagnosis[i].Assessment_Type;
                        if (Diag_Type == "LOINC")
                            Type = "Lab";
                        if (i == 0)
                        {
                        ...
                        sInnerXML += "<tr><td>" + Type + "</td><td>" + ClinicalSummary.Case_Report_EncounterDiagnosis[i].Snomed_Code_Description + "</td><td>" + ClinicalSummary.Case_Report_EncounterDiagnosis[i].Snomed_Code + "</td><td>" + Diag_Type + "</td><td>" + RCTC_OID + "</td><td>" + RCTC_Version + "</td><td>" + ClinicalSummary.Encounter[0].Date_of_Service.ToString("MMMM dd,yyyy") + "</td></tr>";
                        if (i == ClinicalSummary.Case_Report_EncounterDiagnosis.Count - 1)
                        {
                            sInnerXML += "</tbody>";
                        }
                    }
                    xfrag.InnerXml = sInnerXML.Replace("&", "&amp;");
                    elemOldtblEncDiagDtls.AppendChild(xfrag);

                    XmlElement elemOldentrytblEncDiagDtls = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1];
                    IList<Assessment> Case_Report_EncDiag_Snomed = ClinicalSummary.Case_Report_EncounterDiagnosis.Where(a => a.Assessment_Type == "SNOMED").ToList<Assessment>();
                    IList<Assessment> Case_Report_EncDiag_Loinc = ClinicalSummary.Case_Report_EncounterDiagnosis.Where(a => a.Assessment_Type == "LOINC").ToList<Assessment>();
                    int EncDiag_SnomedCount = 0;
                    if (Case_Report_EncDiag_Snomed != null && Case_Report_EncDiag_Snomed.Count > 0)
                    {
                        XmlDocument docAllergyEntry = new XmlDocument();
                        EncDiag_SnomedCount = Case_Report_EncDiag_Snomed.Count;
                        //HimajadocAllergyEntry.Load(Path.Combine(System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath, "SampleXML\\Goal_Section.xml"));
                        docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Encounter_CDA.xml"));

                        for (int i = 0; i < Case_Report_EncDiag_Snomed.Count; i++)
                        {
                            XmlDocumentFragment xfragAllergy = xmlDoc.CreateDocumentFragment();
                            xfragAllergy.InnerXml = docAllergyEntry.DocumentElement.InnerXml;
                            elemOldentrytblEncDiagDtls.LastChild.AppendChild(xfragAllergy);
                            xmlDoc.Save(sPrintFileName);
                            xmlDoc.Load(sPrintFileName);


                            elemOldentrytblEncDiagDtls = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1];

                            XmlElement elemEffectiveTime = null;
                            XmlElement elemEffectiveTimeLow = null;
                            XmlElement elemCodeValue = null;

                            elemEffectiveTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + i].ChildNodes[0].ChildNodes[6];
                            elemEffectiveTimeLow = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + i].ChildNodes[0].ChildNodes[8].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[9].ChildNodes[0];
                            elemCodeValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + i].ChildNodes[0].ChildNodes[8].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[11];

                            elemEffectiveTime.Attributes.GetNamedItem("value").Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
                            elemEffectiveTimeLow.Attributes.GetNamedItem("value").Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
                            elemCodeValue.Attributes.GetNamedItem("code").Value = Case_Report_EncDiag_Snomed[i].Snomed_Code;
                            elemCodeValue.Attributes.GetNamedItem("displayName").Value = Case_Report_EncDiag_Snomed[i].Snomed_Code_Description;
                            elemCodeValue.Attributes.GetNamedItem("sdtc:valueSet").Value = RCTC_OID;
                            elemCodeValue.Attributes.GetNamedItem("sdtc:valueSetVersion").Value = RCTC_Version;
                        }


                    }

                    if (Case_Report_EncDiag_Loinc != null && Case_Report_EncDiag_Loinc.Count > 0)
                    {
                        XmlDocument docAllergyEntry = new XmlDocument();

                        //HimajadocAllergyEntry.Load(Path.Combine(System.Web.Hosting.HostingEnvironment.ApplicationPhysicalPath, "SampleXML\\Goal_Section.xml"));
                        docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Encounter_CDA_Loinc.xml"));

                        for (int i = 0; i < Case_Report_EncDiag_Loinc.Count; i++)
                        {
                            XmlDocumentFragment xfragAllergy = xmlDoc.CreateDocumentFragment();
                            xfragAllergy.InnerXml = docAllergyEntry.DocumentElement.InnerXml;
                            elemOldentrytblEncDiagDtls.LastChild.AppendChild(xfragAllergy);
                            ...
                            XmlElement elemLoincCode = null;
                            XmlElement elemLoincCodeObv = null;
                            XmlElement elemLoincEffectveTimeObv = null;
                            XmlElement elemLoincValueObv = null;
                            XmlElement elemLoincRefRange = null;
                            XmlElement elemLoincText = null;
                            XmlElement elemLoincLHValue = null;
                            XmlElement elemLoincTriggerCode = null;

                            elemLoincCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + EncDiag_SnomedCount + i].ChildNodes[0].ChildNodes[2];
                            elemLoincCodeObv = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + EncDiag_SnomedCount + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[3];
                            elemLoincEffectveTimeObv = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + EncDiag_SnomedCount + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[5];
                            elemLoincValueObv = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + EncDiag_SnomedCount + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[6];
                            elemLoincRefRange = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + EncDiag_SnomedCount + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[9];
                            elemLoincText = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + EncDiag_SnomedCount + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[9].ChildNodes[0].ChildNodes[0];
                            elemLoincLHValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + EncDiag_SnomedCount + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[9].ChildNodes[0].ChildNodes[1];
                            elemLoincTriggerCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[11 + EncDiag_SnomedCount + i].ChildNodes[0].ChildNodes[4].ChildNodes[0].ChildNodes[11];

                            elemLoincCode.Attributes.GetNamedItem("code").Value = Case_Report_EncDiag_Loinc[i].Snomed_Code;
                            elemLoincCode.Attributes.GetNamedItem("displayName").Value = Case_Report_EncDiag_Loinc[i].Snomed_Code_Description;
                            elemLoincCodeObv.Attributes.GetNamedItem("code").Value = Case_Report_EncDiag_Loinc[i].Snomed_Code;
                            elemLoincCodeObv.Attributes.GetNamedItem("displayName").Value = Case_Report_EncDiag_Loinc[i].Snomed_Code_Description;
                            elemLoincEffectveTimeObv.Attributes.GetNamedItem("value").Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
                            if (Case_Report_EncDiag_Loinc[i].ICD.Trim() == string.Empty)
                            {
                                elemLoincValueObv.ParentNode.RemoveChild(elemLoincValueObv);
                            }
                            else
                            {
                                elemLoincValueObv.Attributes.GetNamedItem("value").Value = Case_Report_EncDiag_Loinc[i].ICD;
                                elemLoincValueObv.Attributes.GetNamedItem("unit").Value = Case_Report_EncDiag_Loinc[i].ICD_Description;
                            }

                            if (Case_Report_EncDiag_Loinc[i].ICD_9_Description.Trim() == string.Empty)
                            {
                                elemLoincRefRange.ParentNode.RemoveChild(elemLoincRefRange);
                            }
                            else
                            {
                                elemLoincText.InnerText = Case_Report_EncDiag_Loinc[i].ICD_9;
                                elemLoincLHValue.ChildNodes[0].Attributes.GetNamedItem("value").Value = Case_Report_EncDiag_Loinc[i].ICD_9_Description.Split('-')[0];
                                elemLoincLHValue.ChildNodes[0].Attributes.GetNamedItem("unit").Value = Case_Report_EncDiag_Loinc[i].ICD_Description;
                                elemLoincLHValue.ChildNodes[1].Attributes.GetNamedItem("value").Value = Case_Report_EncDiag_Loinc[i].ICD_9_Description.Split('-')[0];
                                elemLoincLHValue.ChildNodes[1].Attributes.GetNamedItem("unit").Value = Case_Report_EncDiag_Loinc[i].ICD_Description;
                            }
                            elemLoincTriggerCode.Attributes.GetNamedItem("code").Value = Case_Report_EncDiag_Loinc[i].Snomed_Code;
                            elemLoincTriggerCode.Attributes.GetNamedItem("displayName").Value = Case_Report_EncDiag_Loinc[i].Snomed_Code_Description;
                            elemLoincTriggerCode.Attributes.GetNamedItem("sdtc:valueSet").Value = RCTC_OID;
                            elemLoincTriggerCode.Attributes.GetNamedItem("sdtc:valueSetVersion").Value = RCTC_Version;
                        }
                ...
                else
                {
                    ...
                    xAttribute.Value = "NI";
                    xelemSection.Attributes.Append(xAttribute);
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[1].ChildNodes[0].ChildNodes[10];
                    elemOld.RemoveAll();
                    elemOld.InnerText = "No known data found";
                    xmlDoc.Save(sPrintFileName);
                    xmlDoc.Load(sPrintFileName);
            ...
            #region HPI
            if (ClinicalSummary.ChiefComplaintsHPI != null && ClinicalSummary.ChiefComplaintsHPI.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[3].ChildNodes[0].ChildNodes[2].InnerText == "History of Present Illness")
                {
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[3].ChildNodes[0].ChildNodes[3];
                    if (ClinicalSummary.ChiefComplaintsHPI[0].HPI_Element.ToString().ToUpper() == "HPI NOTES")
                    {
                        elemOld.InnerText = ClinicalSummary.ChiefComplaintsHPI[0].HPI_Value;
                    }
                    xmlDoc.Save(sPrintFileName);
                    xmlDoc.Load(sPrintFileName);
                }
            ...
            {
                xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[3].ChildNodes[0].ChildNodes[3].InnerText = "No known data found";
                xmlDoc.Save(sPrintFileName);
                xmlDoc.Load(sPrintFileName);
            }
            #endregion
            ...
            #region Medication
            if (ClinicalSummary.Medication != null && ClinicalSummary.Medication.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[5].ChildNodes[0].ChildNodes[3].InnerText == "Medications Administered")
                {
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[5].ChildNodes[0].ChildNodes[4].ChildNodes[0];
                    XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
                    string sInnerXML = string.Empty;
                    for (int i = 0; i < ClinicalSummary.Medication.Count; i++)
                    {
                        ...
                        sInnerXML += "<tr><td>" + ClinicalSummary.Medication[i].Generic_Name + " " + ClinicalSummary.Medication[i].Strength + "</td><td>" + ClinicalSummary.Medication[i].Dose + " " + ClinicalSummary.Medication[i].Dose_Unit + "</td><td>" + ClinicalSummary.Medication[i].Start_Date.ToString("MMMM dd,yyyy") + "</td><td>" + ClinicalSummary.Medication[i].Route + "</td></tr>";
                    ...
                    xfrag.InnerXml = sInnerXML.Replace("&", "&amp;");
                    elemOld.AppendChild(xfrag);

                    XmlElement elemOldEntry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[5];
                    XmlDocument docAllergyEntry = new XmlDocument();
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Medication_CDA.xml"));
                    ...
                    for (int i = 0; i < ClinicalSummary.Medication.Count; i++)
                    {
                        ...
                        xmlDoc.Load(sPrintFileName);
                        elemOldEntry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[5];
                        XmlElement elemMedDose = null;
                        XmlElement elemMedCode = null;
                        elemMedDose = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[5].ChildNodes[0].ChildNodes[5 + i].ChildNodes[0].ChildNodes[8];
                        elemMedCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[5].ChildNodes[0].ChildNodes[5 + i].ChildNodes[0].ChildNodes[9].ChildNodes[0].ChildNodes[3].ChildNodes[0];
                        elemMedDose.Attributes[0].Value = ClinicalSummary.Medication[i].Dose;
                        if (ClinicalSummary.Medication[i].Dose_Unit != "")
                        {
                            elemMedDose.Attributes[1].Value = ClinicalSummary.Medication[i].Dose_Unit;
                        }
                        else
                        {
                            elemMedDose.RemoveAttribute("unit");
                        }
                        elemMedCode.Attributes[0].Value = ClinicalSummary.Medication[i].Rxnorm_ID.ToString();
                        elemMedCode.Attributes[3].Value = ClinicalSummary.Medication[i].Generic_Name;
            ...
            if (ClinicalSummary.ProblemListing != null && ClinicalSummary.ProblemListing.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[5].InnerText == "Problems")
                {
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[6].ChildNodes[1];
                    ...
                    for (int i = 0; i < ClinicalSummary.ProblemListing.Count; i++)
                    {
                        ...
                        elemStatusCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[7 + i].ChildNodes[1].ChildNodes[4];
                        elemStatusCode.Attributes[0].Value = ClinicalSummary.ProblemListing[i].Status.ToLower();

                        elemProbDate = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[7 + i].ChildNodes[1].ChildNodes[5].ChildNodes[0];
                        elemProbDate.Attributes[0].Value = datelow.ToString("yyyyMMdd");

                        elemlow = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[7 + i].ChildNodes[1].ChildNodes[6].ChildNodes[1].ChildNodes[6].ChildNodes[0];
                        elemlow.Attributes[0].Value = datelow.ToString("yyyyMMdd");

                        elemhigh = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[7 + i].ChildNodes[1].ChildNodes[6].ChildNodes[1].ChildNodes[6].ChildNodes[1];
                        elemhigh.Attributes[0].Value = datelow.ToString("yyyyMMdd");


                        elemprobDescription = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[7 + i].ChildNodes[1].ChildNodes[6].ChildNodes[1].ChildNodes[7];
                        elemprobDescription.Attributes[1].Value = ClinicalSummary.ProblemListing[i].Snomed_Code;
                        elemprobDescription.Attributes[4].Value = ClinicalSummary.ProblemListing[i].Snomed_Code_Description;

                        elemUnit = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[7].ChildNodes[0].ChildNodes[7 + i].ChildNodes[1].ChildNodes[6].ChildNodes[1].ChildNodes[8].ChildNodes[1].ChildNodes[3];
            ...
            if (ClinicalSummary.ChiefComplaints != null && ClinicalSummary.ChiefComplaints.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[9].ChildNodes[0].ChildNodes[2].InnerText == "Reason for Visit")
                {
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[9].ChildNodes[0].ChildNodes[3];

                    if (ClinicalSummary.ChiefComplaints[0].HPI_Element.ToString().ToUpper() == "CHIEF COMPLAINTS")
                    {
                        elemOld.InnerText = ClinicalSummary.ChiefComplaints[0].HPI_Value;
                    }
                    xmlDoc.Save(sPrintFileName);
                    xmlDoc.Load(sPrintFileName);
                }
            ...
            {
                xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[9].ChildNodes[0].ChildNodes[3].InnerText = "No known data found";
                xmlDoc.Save(sPrintFileName);
                xmlDoc.Load(sPrintFileName);
            }
            #endregion
            ...
            #region Results
            if (ClinicalSummary.ResultList != null && ClinicalSummary.ResultList.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11].ChildNodes[0].ChildNodes[9].InnerText == "Results")
                {
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11].ChildNodes[0].ChildNodes[10];
                    XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
                    string sInnerXML = string.Empty;
                    ...
                    for (int i = 0; i < ClinicalSummary.ResultList.Count; i++)
                    {
                        ...
                        if (i == 0)
                        {
                            ...
                            if (ClinicalSummary.LabLocationList.Count > 0)
                            {
                                sInnerXML += "<tr><td style='font-weight:bold;'>" + ClinicalSummary.LabLocationList[0].Lab_NPI + "</td><td style='font-weight:bold;'> Laboratory: " + ClinicalSummary.LabLocationList[0].Modified_By + " | " + ClinicalSummary.LabLocationList[0].Location_Name + ", " + ClinicalSummary.LabLocationList[0].Street_Address1 + ", " + ClinicalSummary.LabLocationList[0].City + ", " + ClinicalSummary.LabLocationList[0].State + ", " + ClinicalSummary.LabLocationList[0].ZipCode + ", tel: " + ClinicalSummary.LabLocationList[0].Phone_No + "</td></tr>";
                                //sInnerXML += "<tr><td>" + ClinicalSummary.LabLocationList[0].Lab_NPI + "</td><td> Laboratory: " + ClinicalSummary.LabLocationList[0].Modified_By + " | " + ClinicalSummary.LabLocationList[0].Location_Name + ", " + ClinicalSummary.LabLocationList[0].Street_Address1 + ", " + ClinicalSummary.LabLocationList[0].City + ", " + ClinicalSummary.LabLocationList[0].State + ", " + ClinicalSummary.LabLocationList[0].ZipCode + ", tel: " + ClinicalSummary.LabLocationList[0].Phone_No + "</td></tr>";
                            }
                        }
                        sInnerXML += "<tr><td>" + ClinicalSummary.ResultList[i].OBX_Observation_Text + "</td><td>" + ClinicalSummary.ResultList[i].Created_Date_And_Time.ToString("MMMM dd,yyyy") + "</td></tr>";
                        if (i == ClinicalSummary.ResultList.Count - 1)
                        {
                            sInnerXML += "</tbody>";
                        }
                    ...
                    xfrag.InnerXml = sInnerXML.Replace("&", "&amp;");
                    elemOld.LastChild.AppendChild(xfrag);
                    XmlElement elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11];
                    XmlDocument docAllergyEntry = new XmlDocument();
                    docAllergyEntry.Load(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\bin\\Debug",""), "SampleXML\\Results_CDA.xml"));
                    for (int i = 0; i < ClinicalSummary.ResultList.Count; i++)
                    {
                        XmlDocumentFragment xfragAllergy = xmlDoc.CreateDocumentFragment();
                        xfragAllergy.InnerXml = docAllergyEntry.DocumentElement.InnerXml;
                        ...
                        xmlDoc.Save(sPrintFileName);
                        xmlDoc.Load(sPrintFileName);
                        elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11];
                        XmlElement elemCode = null;
                        XmlElement elemEffectiveTimeLow = null;
                        XmlElement elemEffectiveTimeHigh = null;
                        XmlElement elemCodeSub = null;
                        XmlElement elemEffectiveTimeSub = null;
                        elemCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11].ChildNodes[0].ChildNodes[11 + i].ChildNodes[0].ChildNodes[5];
                        elemEffectiveTimeLow = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11].ChildNodes[0].ChildNodes[11 + i].ChildNodes[0].ChildNodes[7].ChildNodes[0];
                        elemEffectiveTimeHigh = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11].ChildNodes[0].ChildNodes[11 + i].ChildNodes[0].ChildNodes[7].ChildNodes[1];
                        elemCodeSub = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11].ChildNodes[0].ChildNodes[11 + i].ChildNodes[0].ChildNodes[8].ChildNodes[1].ChildNodes[5];
                        elemEffectiveTimeSub = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[11].ChildNodes[0].ChildNodes[11 + i].ChildNodes[0].ChildNodes[8].ChildNodes[1].ChildNodes[7];


                        elemCode.Attributes.GetNamedItem("code").Value = ClinicalSummary.ResultList[i].OBX_Observation_Identifier.ToString();
                        elemCode.Attributes.GetNamedItem("displayName").Value = ClinicalSummary.ResultList[i].OBX_Observation_Text.ToString();
                        elemEffectiveTimeLow.Attributes.GetNamedItem("value").Value = ClinicalSummary.ResultList[i].Created_Date_And_Time.ToString("yyyyMMdd");
                        elemEffectiveTimeHigh.Attributes.GetNamedItem("value").Value = ClinicalSummary.ResultList[i].Created_Date_And_Time.ToString("yyyyMMdd");
                        elemCodeSub.Attributes.GetNamedItem("code").Value = ClinicalSummary.ResultList[i].OBX_Observation_Identifier.ToString();
                        elemCodeSub.Attributes.GetNamedItem("displayName").Value = ClinicalSummary.ResultList[i].OBX_Observation_Text.ToString();
                        elemEffectiveTimeSub.Attributes.GetNamedItem("value").Value = ClinicalSummary.ResultList[i].Created_Date_And_Time.ToString("yyyyMMdd");
            ...
            #region SocialHistory
            if (ClinicalSummary.SocialHistory != null && ClinicalSummary.SocialHistory.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13].ChildNodes[0].ChildNodes[3].InnerText == "Social History")
                {
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13].ChildNodes[0].ChildNodes[4].ChildNodes[0];
                    XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
                    string sInnerXML = string.Empty;
                    IList<SocialHistory> ilstSocialHistory1 = new List<SocialHistory>();
                    for (int i = 0; i < ClinicalSummary.SocialHistory.Count; i++)
                    ...
                    XmlElement elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13];
                    for (int i = 0; i < ilstSocialHistory1.Count; i++)
                    {
                        ...
                        if (ilstSocialHistory1[i].Social_Info.ToUpper() == "TOBACCO USE AND EXPOSURE")
                        {
                            ...
                            elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13];
                            XmlElement eleDisplayName = null;
                            XmlElement eleLowTime = null;
                            XmlElement elemValue = null;

                            eleDisplayName = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13].ChildNodes[0].ChildNodes[5 + i].ChildNodes[0].ChildNodes[3];
                            eleDisplayName.Attributes[3].Value = ilstSocialHistory1[i].Social_Info;

                            eleLowTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13].ChildNodes[0].ChildNodes[5 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0];
                            eleLowTime.Attributes[0].Value = ilstSocialHistory1[i].Modified_Date_And_Time.ToString("yyyyMMdd") != "00010101" ? ilstSocialHistory1[i].Modified_Date_And_Time.ToString("yyyyMMdd") : ilstSocialHistory1[i].Created_Date_And_Time.ToString("yyyyMMdd");

                            elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13].ChildNodes[0].ChildNodes[5 + i].ChildNodes[0].ChildNodes[6];
                            elemValue.Attributes[1].Value = ilstSocialHistory1[i].Recodes.ToString();
                            elemValue.Attributes[2].Value = ilstSocialHistory1[i].Social_Info;
                        ...
                        else if (ilstSocialHistory1[i].Social_Info.ToUpper() == "SMOKING HABIT")
                        {
                            ...
                            elemOldentry = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13];
                            XmlElement elemValue = null;
                            elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13].ChildNodes[0].ChildNodes[5 + i].ChildNodes[1].ChildNodes[5];
                            elemValue.Attributes[1].Value = ilstSocialHistory1[i].Recodes.ToString();
                            elemValue.Attributes[3].Value = ilstSocialHistory1[i].Social_Info;
            ...
            else
            {
                ...
                xAttribute.Value = "NI";
                xelemSection.Attributes.Append(xAttribute);
                XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[13].ChildNodes[0].ChildNodes[4];
                elemOld.RemoveAll();
                elemOld.InnerText = "No known data found";
                xmlDoc.Save(sPrintFileName);
                xmlDoc.Load(sPrintFileName);
            ...
            if (ClinicalSummary.Vitals != null && ClinicalSummary.Vitals.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[2].InnerText.ToUpper() == "VITAL SIGNS")
                {
                    ...
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[3];
                    XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
                    string sInnerXML = string.Empty;
                    XmlElement elemDate1 = null;
                    elemDate1 = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[3].ChildNodes[0].ChildNodes[0].ChildNodes[0].ChildNodes[1];
                    elemDate1.InnerText = ilstPatientResult1[0].Captured_date_and_time.ToString("yyyy-MM-dd");
                    for (int i = 0; i < ilstPatientResult1.Count; i++)
                    {
                    ...
                    for (int i = 0; i < ilstPatientResult1.Count; i++)
                    {
                        if (ilstPatientResult1[i].Loinc_Observation.ToUpper() != "BP-SITTING SYS/DIA")
                        {
                            ...
                            elemVitalCapturedDateTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[4];
                            if (ilstPatientResult1[i].Results_Type.ToString().ToUpper() == "VITALS")
                                elemVitalCapturedDateTime.Attributes[0].Value = ilstPatientResult1[i].Captured_date_and_time.ToString("yyyyMMdd");
                            elemCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[3];
                            string sLoincIdentifier = ilstPatientResult1[i].Loinc_Identifier;
                            if (sLoincIdentifier != string.Empty)
                                elemCode.Attributes[0].Value = sLoincIdentifier;
                            else
                                elemCode.Attributes[0].Value = "39156-5";
                            elemCode.Attributes[3].Value = ilstPatientResult1[i].Loinc_Observation;
                            elemEffectiveTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[6];
                            if (ilstPatientResult1[i].Results_Type.ToString().ToUpper() == "VITALS")
                                elemEffectiveTime.Attributes[0].Value = ilstPatientResult1[i].Captured_date_and_time.ToString("yyyyMMdd");
                            elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[4 + i].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[7];
                            string sValues = ilstPatientResult1[i].Value;
                            if (ilstPatientResult1[i].Loinc_Observation == "Height")
                            {
                                if (ilstPatientResult1[i].Value == string.Empty)
                            ...
                            if (sUnits != string.Empty)
                            {
                                ...
                                {
                                    elemValue.Attributes[2].Value = sUnits;
                        ...
                        else
                        {

                            {
                                ...
                                foreach (string sdia in s)
                                {
                                    ...
                                    elemVitalCapturedDateTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[4 + iArryCount].ChildNodes[0].ChildNodes[4];
                                    if (ilstPatientResult1[i].Results_Type.ToString().ToUpper() == "VITALS")
                                        elemVitalCapturedDateTime.Attributes[0].Value = ilstPatientResult1[i].Captured_date_and_time.ToString("yyyyMMdd");
                                    elemCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[4 + iArryCount].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[3];
                                    string sLoincIdentifier = ilstPatientResult1[i].Loinc_Identifier;
                                    ...
                                    elemEffectiveTime = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[4 + iArryCount].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[6];
                                    if (ilstPatientResult1[i].Results_Type.ToString().ToUpper() == "VITALS")
                                        elemEffectiveTime.Attributes[0].Value = ilstPatientResult1[i].Captured_date_and_time.ToString("yyyyMMdd");
                                    elemValue = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[15].ChildNodes[0].ChildNodes[4 + iArryCount].ChildNodes[0].ChildNodes[5].ChildNodes[0].ChildNodes[7];
                                    string sValues = ilstPatientResult1[i].Value;
                                    if (ilstPatientResult1[i].Loinc_Observation == "Height")
                                    {
                                        if (sValues == string.Empty)
                                    ...
                                    if (sUnits != string.Empty)
                                        elemValue.Attributes[2].Value = "mm[Hg]";
                                    else
                                        elemValue.Attributes[2].Value = "kg/m2";
                                }
                            }
            ...
            #region Procedures
            if (ClinicalSummary.laborderList != null && ClinicalSummary.laborderList.Count != 0)
            {
                UtilityManager umanger = new UtilityManager();
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[17].ChildNodes[0].ChildNodes[2].InnerText == "Procedures")
                {
            ...
            #region LaboratoryTests
            if (ClinicalSummary.OrdersList != null && ClinicalSummary.OrdersList.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[19].ChildNodes[0].ChildNodes[0].InnerText == "Laboratory Tests")
                {
            ...
            if (ClinicalSummary.immunhistoryList != null && ClinicalSummary.immunhistoryList.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[2].InnerText == "Immunizations")
                {
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[3];
                    XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
                    string sInnerXML = string.Empty;
                    ...
                    for (int i = 0; i < ClinicalSummary.immunhistoryList.Count; i++)
                    {
                        ...
                        if (sdate != "")
                        {
                            if (ClinicalSummary.immunhistoryList[i].Immunization_Source != "" && ClinicalSummary.immunhistoryList[i].Immunization_Source == "Refused Administration")
                            {
                                sInnerXML += "<tr><td>" + ClinicalSummary.immunhistoryList[i].Immunization_Description + " CVX:" + ClinicalSummary.immunhistoryList[i].CVX_Code + "</td><td>" + dtAdministrativedate.ToString("MMMM dd,yyyy") + "</td><td>Canceled</td><td>" + ClinicalSummary.immunhistoryList[i].Notes + "</td></tr>";
                            }
                            else
                            {
                                sInnerXML += "<tr><td>" + ClinicalSummary.immunhistoryList[i].Immunization_Description + " CVX:" + ClinicalSummary.immunhistoryList[i].CVX_Code + "</td><td>" + dtAdministrativedate.ToString("MMMM dd,yyyy") + "</td><td>Completed</td><td></td></tr>";
                        ...
                        else
                        {
                            if (ClinicalSummary.immunhistoryList[i].Immunization_Source != "" && ClinicalSummary.immunhistoryList[i].Immunization_Source == "Refused Administration")
                            {
                                sInnerXML += "<tr><td>" + ClinicalSummary.immunhistoryList[i].Immunization_Description + " CVX:" + ClinicalSummary.immunhistoryList[i].CVX_Code + "</td><td></td><td>Canceled</td><td>" + ClinicalSummary.immunhistoryList[i].Notes + "</td></tr>";
                            }
                            else
                            {
                                sInnerXML += "<tr><td>" + ClinicalSummary.immunhistoryList[i].Immunization_Description + " CVX:" + ClinicalSummary.immunhistoryList[i].CVX_Code + "</td><td></td><td>Completed</td><td></td></tr>";
                    ...
                    for (int i = 0; i < ClinicalSummary.immunhistoryList.Count; i++)
                    {
                        ...
                        elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[3].ChildNodes[1];
                        ...
                        elemReference = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[3];
                        elemGivenDate = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[5];

                        elemImmCvxCode = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[6].ChildNodes[0].ChildNodes[3].ChildNodes[0];
                        elemImmLotNumber = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[21].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[6].ChildNodes[0].ChildNodes[3].ChildNodes[1];
                        if (ClinicalSummary.immunhistoryList[i].Lot_Number.Trim() != "")
                            elemImmLotNumber.InnerText = ClinicalSummary.immunhistoryList[i].Lot_Number;
                        else
                        {
            ...
            if (ClinicalSummary.OthertreatmentPlan != null && ClinicalSummary.OthertreatmentPlan.Count != 0)
            {
                if (xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[2].InnerText == "Plan of Care")
                {
                    XmlElement elemOld = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[3];
                    XmlDocumentFragment xfrag = xmlDoc.CreateDocumentFragment();
                    string sInnerXML = string.Empty;
                    ...
                    for (int i = 0; i < ClinicalSummary.OthertreatmentPlan.Count; i++)
                    {
                        ...
                        elemPlanName = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[4];
                        if (ClinicalSummary.OthertreatmentPlan[i].Plan_For_Plan.Trim() != "")
                            elemPlanName.Attributes[3].Value = ClinicalSummary.OthertreatmentPlan[i].Plan.Replace("&#xD;&#xA;", "").Replace("&#xA;", " ").Replace("&#xD;", " ").Replace("\r\n", "").Replace("\n", "").Replace("\r", "").Replace("-Vitals", "").Replace("-Problem List", "").Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("'", "&apos;").Replace("\"", "&quot;") + " - " + ClinicalSummary.OthertreatmentPlan[i].Plan_For_Plan.Replace("&#xD;&#xA;", "").Replace("&#xA;", " ").Replace("&#xD;", " ").Replace("\r\n", "").Replace("\n", "").Replace("\r", "");
                        else
                            elemPlanName.Attributes[3].Value = ClinicalSummary.OthertreatmentPlan[i].Plan.Replace("&#xD;&#xA;", "").Replace("&#xA;", " ").Replace("&#xD;", " ").Replace("\r\n", "").Replace("\n", "").Replace("\r", "").Replace("-Vitals", "").Replace("-Problem List", "").Replace("&", "&amp;").Replace("<", "&lt;").Replace(">", "&gt;").Replace("'", "&apos;").Replace("\"", "&quot;");
                        elemelemdate = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0].ChildNodes[4 + i].ChildNodes[1].ChildNodes[7];
                        elemelemdate.Attributes[0].Value = ClinicalSummary.Encounter[0].Date_of_Service.ToString("yyyyMMdd");
                    }
                }
            }
            ...
            {
                XmlElement xBookParticipant = (XmlElement)xmlDoc.GetElementsByTagName("structuredBody")[0].ChildNodes[23].ChildNodes[0];
                XmlAttribute xAttribute = xBookParticipant.OwnerDocument.CreateAttribute("nullFlavor");
                xAttribute.Value = "NI";
                xBookParticipant.Attributes.Append(xAttribute);
