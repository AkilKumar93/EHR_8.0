    ...
    public partial class frmConsultationNotes : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string strXmlEncounterPath = Path.Combine(System.Configuration.ConfigurationSettings.AppSettings["XMLPath"], FileNames);
            ...
            else
            {
                using (var fileStream = new FileStream(pdfFileNamewithHeader, FileMode.Create, FileAccess.Write))
                {
                    ...
                    for (var i = 1; i <= count; i++)
                    {
                        ...
                        {
                            con.ShowTextAligned(PdfContentByte.ALIGN_LEFT, strfooterProvider, 30, 20, 0);
