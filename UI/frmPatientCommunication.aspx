...
<%--                                                             <button id="btnPrint" type="button" class="aspresizedbluebutton" onclick="btnPrint_Clicked();return false;" >Print</button>--%>
                                                    ...
                                                    <tr id="RowForHide" runat="server">
                                                        <td align="right" style="width: 100%">
                                                            ...
                                                            <input type="button" id="btnSaveSendMyQ" value="Save and Send" onclick="return SaveClick(this);" class="aspresizedgreenbutton" />
                                                            <input type="button" id="btnSaveCompletedMyQ" value="Save and Completed" onclick="return SaveClick(this);" class="aspresizedgreenbutton" />
