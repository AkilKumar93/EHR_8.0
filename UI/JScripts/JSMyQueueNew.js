        ...
        success: function (data) {
            ...
            if (objdata.length > 0) {
                for (var i = 0; i < objdata.length; i++) {
                    ...
                    if (i == 0)
                        tabContents = "<tr><td style='width:2%'><input type='checkbox' onclick='checkboxclick(this)'/></td><td style='width:7%'>" + objdata[i].Priority + "</td><td style='width:5%'>" + objdata[i].Human_ID + "</td><td style='width:7%'>" + objdata[i].Last_Name + "," + objdata[i].First_Name + " " + objdata[i].MI + "</td><td style='width:8%'>" + ConvertDate(objdata[i].Msg_Date_And_Time.replace("T", " ")) + "</td><td style='width:7%' title='" + objdata[i].Message_Notes.replace(/[\r\n]+/gm, "").replace('<br/>', " ") + "'>" + objdata[i].Message_Description + "</td><td style='width:7%'>" + objdata[i].Facility_Name + "</td><td style='width:7%'>" + objdata[i].Created_By + "</td><td style='display:none'>" + objdata[i].Message_ID + "</td></tr>";
                    else
