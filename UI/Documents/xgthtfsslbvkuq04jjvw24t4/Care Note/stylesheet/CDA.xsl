      ...
      <tbody>
        ...
        <td width="80%">
          ...
          <xsl:choose>
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;abk&apos;">
              <xsl:text>Abkhazian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ace&apos;">
              <xsl:text>Achinese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ach&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;ada&apos;">
              <xsl:text>Adangme</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ady&apos;">
              <xsl:text>Adygei</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ady&apos;">
              <xsl:text>Adyghe</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;aar&apos;">
              <xsl:text>Afar</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;afh&apos;">
              <xsl:text>Afrihili</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;afr&apos;">
              <xsl:text>Afrikaans</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;afa&apos;">
              <xsl:text>Afro-Asiatic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ain&apos;">
              <xsl:text>Ainu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;aka&apos;">
              <xsl:text>Akan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;akk&apos;">
              <xsl:text>Akkadian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;alb/sqi&apos;">
              <xsl:text>Albanian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gsw&apos;">
              <xsl:text>Alemannic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ale&apos;">
              <xsl:text>Aleut</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;alg&apos;">
              <xsl:text>Algonquian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gsw&apos;">
              <xsl:text>Alsatian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tut&apos;">
              <xsl:text>Altaic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;amh&apos;">
              <xsl:text>Amharic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;anp&apos;">
              <xsl:text>Angika</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;apa&apos;">
              <xsl:text>Apache languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ara&apos;">
              <xsl:text>Arabic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;arg&apos;">
              <xsl:text>Aragonese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;arp&apos;">
              <xsl:text>Arapaho</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;arw&apos;">
              <xsl:text>Arawak</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;arm/hye&apos;">
              <xsl:text>Armenian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rup&apos;">
              <xsl:text>Aromanian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;art&apos;">
              <xsl:text>Artificial languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rup&apos;">
              <xsl:text>Arumanian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;asm&apos;">
              <xsl:text>Assamese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ast&apos;">
              <xsl:text>Asturian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ast&apos;">
              <xsl:text>Asturleonese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ath&apos;">
              <xsl:text>Athapascan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;aus&apos;">
              <xsl:text>Australian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;map&apos;">
              <xsl:text>Austronesian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ava&apos;">
              <xsl:text>Avaric</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ave&apos;">
              <xsl:text>Avestan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;awa&apos;">
              <xsl:text>Awadhi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;aym&apos;">
              <xsl:text>Aymara</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;aze&apos;">
              <xsl:text>Azerbaijani</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ast&apos;">
              <xsl:text>Bable</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ban&apos;">
              <xsl:text>Balinese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bat&apos;">
              <xsl:text>Baltic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bal&apos;">
              <xsl:text>Baluchi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bam&apos;">
              <xsl:text>Bambara</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bai&apos;">
              <xsl:text>Bamileke languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bad&apos;">
              <xsl:text>Banda languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bnt&apos;">
              <xsl:text>Bantu languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bas&apos;">
              <xsl:text>Basa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bak&apos;">
              <xsl:text>Bashkir</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;baq/eus&apos;">
              <xsl:text>Basque</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;btk&apos;">
              <xsl:text>Batak languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bej&apos;">
              <xsl:text>Bedawiyet</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bej&apos;">
              <xsl:text>Beja</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bel&apos;">
              <xsl:text>Belarusian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bem&apos;">
              <xsl:text>Bemba</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ben&apos;">
              <xsl:text>Bengali</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ber&apos;">
              <xsl:text>Berber languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bho&apos;">
              <xsl:text>Bhojpuri</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bih&apos;">
              <xsl:text>Bihari languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bik&apos;">
              <xsl:text>Bikol</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;byn&apos;">
              <xsl:text>Bilin</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bin&apos;">
              <xsl:text>Bini</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bis&apos;">
              <xsl:text>Bislama</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;byn&apos;">
              <xsl:text>Blin</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zbl&apos;">
              <xsl:text>Bliss</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zbl&apos;">
              <xsl:text>Blissymbolics</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zbl&apos;">
              <xsl:text>Blissymbols</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nob&apos;">
              <xsl:text>Bokmål, Norwegian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bos&apos;">
              <xsl:text>Bosnian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bra&apos;">
              <xsl:text>Braj</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bre&apos;">
              <xsl:text>Breton</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bug&apos;">
              <xsl:text>Buginese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bul&apos;">
              <xsl:text>Bulgarian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bua&apos;">
              <xsl:text>Buriat</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bur/mya&apos;">
              <xsl:text>Burmese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cad&apos;">
              <xsl:text>Caddo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;spa&apos;">
              <xsl:text>Castilian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cat&apos;">
              <xsl:text>Catalan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cau&apos;">
              <xsl:text>Caucasian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ceb&apos;">
              <xsl:text>Cebuano</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cel&apos;">
              <xsl:text>Celtic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cai&apos;">
              <xsl:text>Central American Indian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;khm&apos;">
              <xsl:text>Central Khmer</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chg&apos;">
              <xsl:text>Chagatai</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cmc&apos;">
              <xsl:text>Chamic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cha&apos;">
              <xsl:text>Chamorro</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;che&apos;">
              <xsl:text>Chechen</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chr&apos;">
              <xsl:text>Cherokee</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nya&apos;">
              <xsl:text>Chewa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chy&apos;">
              <xsl:text>Cheyenne</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chb&apos;">
              <xsl:text>Chibcha</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nya&apos;">
              <xsl:text>Chichewa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chi/zho&apos;">
              <xsl:text>Chinese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chn&apos;">
              <xsl:text>Chinook jargon</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chp&apos;">
              <xsl:text>Chipewyan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cho&apos;">
              <xsl:text>Choctaw</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zha&apos;">
              <xsl:text>Chuang</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chu&apos;">
              <xsl:text>Church Slavic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chu&apos;">
              <xsl:text>Church Slavonic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chk&apos;">
              <xsl:text>Chuukese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chv&apos;">
              <xsl:text>Chuvash</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nwc&apos;">
              <xsl:text>Classical Nepal Bhasa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nwc&apos;">
              <xsl:text>Classical Newari</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;syc&apos;">
              <xsl:text>Classical Syriac</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rar&apos;">
              <xsl:text>Cook Islands Maori</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cop&apos;">
              <xsl:text>Coptic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cor&apos;">
              <xsl:text>Cornish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cos&apos;">
              <xsl:text>Corsican</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cre&apos;">
              <xsl:text>Cree</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mus&apos;">
              <xsl:text>Creek</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;crp&apos;">
              <xsl:text>Creoles and pidgins</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cpe&apos;">
              <xsl:text>Creoles and pidgins, English based</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cpf&apos;">
              <xsl:text>Creoles and pidgins, French-based</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cpp&apos;">
              <xsl:text>Creoles and pidgins, Portuguese-based</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;crh&apos;">
              <xsl:text>Crimean Tatar</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;crh&apos;">
              <xsl:text>Crimean Turkish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hrv&apos;">
              <xsl:text>Croatian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cus&apos;">
              <xsl:text>Cushitic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cze/ces&apos;">
              <xsl:text>Czech</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dak&apos;">
              <xsl:text>Dakota</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dan&apos;">
              <xsl:text>Danish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dar&apos;">
              <xsl:text>Dargwa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;del&apos;">
              <xsl:text>Delaware</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chp&apos;">
              <xsl:text>Dene Suline</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;div&apos;">
              <xsl:text>Dhivehi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zza&apos;">
              <xsl:text>Dimili</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zza&apos;">
              <xsl:text>Dimli</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;din&apos;">
              <xsl:text>Dinka</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;div&apos;">
              <xsl:text>Divehi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;doi&apos;">
              <xsl:text>Dogri</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dgr&apos;">
              <xsl:text>Dogrib</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dra&apos;">
              <xsl:text>Dravidian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dua&apos;">
              <xsl:text>Duala</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dut/nld&apos;">
              <xsl:text>Dutch</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dum&apos;">
              <xsl:text>Dutch, Middle (ca.1050-1350)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dyu&apos;">
              <xsl:text>Dyula</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dzo&apos;">
              <xsl:text>Dzongkha</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;frs&apos;">
              <xsl:text>Eastern Frisian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bin&apos;">
              <xsl:text>Edo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;efi&apos;">
              <xsl:text>Efik</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;egy&apos;">
              <xsl:text>Egyptian (Ancient)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;eka&apos;">
              <xsl:text>Ekajuk</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;elx&apos;">
              <xsl:text>Elamite</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;eng&apos;">
              <xsl:text>English</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;enm&apos;">
              <xsl:text>English, Middle (1100-1500)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ang&apos;">
              <xsl:text>English, Old (ca.450-1100)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;myv&apos;">
              <xsl:text>Erzya</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;epo&apos;">
              <xsl:text>Esperanto</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;est&apos;">
              <xsl:text>Estonian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ewe&apos;">
              <xsl:text>Ewe</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ewo&apos;">
              <xsl:text>Ewondo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fan&apos;">
              <xsl:text>Fang</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fat&apos;">
              <xsl:text>Fanti</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fao&apos;">
              <xsl:text>Faroese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fij&apos;">
              <xsl:text>Fijian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fil&apos;">
              <xsl:text>Filipino</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fin&apos;">
              <xsl:text>Finnish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fiu&apos;">
              <xsl:text>Finno-Ugrian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dut/nld&apos;">
              <xsl:text>Flemish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fon&apos;">
              <xsl:text>Fon</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fre/fra&apos;">
              <xsl:text>French</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;frm&apos;">
              <xsl:text>French, Middle (ca.1400-1600)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fro&apos;">
              <xsl:text>French, Old (842-ca.1400)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fur&apos;">
              <xsl:text>Friulian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ful&apos;">
              <xsl:text>Fulah</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gaa&apos;">
              <xsl:text>Ga</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gla&apos;">
              <xsl:text>Gaelic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;car&apos;">
              <xsl:text>Galibi Carib</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;glg&apos;">
              <xsl:text>Galician</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lug&apos;">
              <xsl:text>Ganda</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gay&apos;">
              <xsl:text>Gayo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gba&apos;">
              <xsl:text>Gbaya</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gez&apos;">
              <xsl:text>Geez</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;geo/kat&apos;">
              <xsl:text>Georgian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ger/deu&apos;">
              <xsl:text>German</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nds&apos;">
              <xsl:text>German, Low</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gmh&apos;">
              <xsl:text>German, Middle High (ca.1050-1500)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;goh&apos;">
              <xsl:text>German, Old High (ca.750-1050)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gem&apos;">
              <xsl:text>Germanic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kik&apos;">
              <xsl:text>Gikuyu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gil&apos;">
              <xsl:text>Gilbertese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gon&apos;">
              <xsl:text>Gondi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gor&apos;">
              <xsl:text>Gorontalo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;got&apos;">
              <xsl:text>Gothic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;grb&apos;">
              <xsl:text>Grebo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;grc&apos;">
              <xsl:text>Greek, Ancient (to 1453)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gre/ell&apos;">
              <xsl:text>Greek, Modern (1453-)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kal&apos;">
              <xsl:text>Greenlandic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;grn&apos;">
              <xsl:text>Guarani</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;guj&apos;">
              <xsl:text>Gujarati</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gwi&apos;">
              <xsl:text>Gwich'in</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hai&apos;">
              <xsl:text>Haida</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hat&apos;">
              <xsl:text>Haitian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hat&apos;">
              <xsl:text>Haitian Creole</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hau&apos;">
              <xsl:text>Hausa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;haw&apos;">
              <xsl:text>Hawaiian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;heb&apos;">
              <xsl:text>Hebrew</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;her&apos;">
              <xsl:text>Herero</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hil&apos;">
              <xsl:text>Hiligaynon</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;him&apos;">
              <xsl:text>Himachali languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hin&apos;">
              <xsl:text>Hindi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hmo&apos;">
              <xsl:text>Hiri Motu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hit&apos;">
              <xsl:text>Hittite</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hmn&apos;">
              <xsl:text>Hmong</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hun&apos;">
              <xsl:text>Hungarian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hup&apos;">
              <xsl:text>Hupa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;iba&apos;">
              <xsl:text>Iban</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ice/isl&apos;">
              <xsl:text>Icelandic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ido&apos;">
              <xsl:text>Ido</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ibo&apos;">
              <xsl:text>Igbo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ijo&apos;">
              <xsl:text>Ijo languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ilo&apos;">
              <xsl:text>Iloko</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;arc&apos;">
              <xsl:text>Imperial Aramaic (700-300 BCE)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;smn&apos;">
              <xsl:text>Inari Sami</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;inc&apos;">
              <xsl:text>Indic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ine&apos;">
              <xsl:text>Indo-European languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ind&apos;">
              <xsl:text>Indonesian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;inh&apos;">
              <xsl:text>Ingush</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ina&apos;">
              <xsl:text>Interlingua (International Auxiliary Language Association)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ile&apos;">
              <xsl:text>Interlingue</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;iku&apos;">
              <xsl:text>Inuktitut</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ipk&apos;">
              <xsl:text>Inupiaq</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ira&apos;">
              <xsl:text>Iranian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gle&apos;">
              <xsl:text>Irish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mga&apos;">
              <xsl:text>Irish, Middle (900-1200)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sga&apos;">
              <xsl:text>Irish, Old (to 900)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;iro&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;jav&apos;">
              <xsl:text>Javanese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kac&apos;">
              <xsl:text>Jingpho</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;jrb&apos;">
              <xsl:text>Judeo-Arabic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;jpr&apos;">
              <xsl:text>Judeo-Persian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kbd&apos;">
              <xsl:text>Kabardian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kab&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;xal&apos;">
              <xsl:text>Kalmyk</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kam&apos;">
              <xsl:text>Kamba</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kan&apos;">
              <xsl:text>Kannada</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kau&apos;">
              <xsl:text>Kanuri</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pam&apos;">
              <xsl:text>Kapampangan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kaa&apos;">
              <xsl:text>Kara-Kalpak</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;krc&apos;">
              <xsl:text>Karachay-Balkar</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;krl&apos;">
              <xsl:text>Karelian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kar&apos;">
              <xsl:text>Karen languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kas&apos;">
              <xsl:text>Kashmiri</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;csb&apos;">
              <xsl:text>Kashubian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kaw&apos;">
              <xsl:text>Kawi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kaz&apos;">
              <xsl:text>Kazakh</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kha&apos;">
              <xsl:text>Khasi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;khi&apos;">
              <xsl:text>Khoisan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kho&apos;">
              <xsl:text>Khotanese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kik&apos;">
              <xsl:text>Kikuyu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kmb&apos;">
              <xsl:text>Kimbundu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kin&apos;">
              <xsl:text>Kinyarwanda</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zza&apos;">
              <xsl:text>Kirdki</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kir&apos;">
              <xsl:text>Kirghiz</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zza&apos;">
              <xsl:text>Kirmanjki</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tlh&apos;">
              <xsl:text>Klingon</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kom&apos;">
              <xsl:text>Komi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kon&apos;">
              <xsl:text>Kongo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kok&apos;">
              <xsl:text>Konkani</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kor&apos;">
              <xsl:text>Korean</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kos&apos;">
              <xsl:text>Kosraean</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kpe&apos;">
              <xsl:text>Kpelle</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kro&apos;">
              <xsl:text>Kru languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kua&apos;">
              <xsl:text>Kuanyama</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kum&apos;">
              <xsl:text>Kumyk</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kur&apos;">
              <xsl:text>Kurdish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kru&apos;">
              <xsl:text>Kurukh</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;kut&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;lad&apos;">
              <xsl:text>Ladino</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lah&apos;">
              <xsl:text>Lahnda</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lam&apos;">
              <xsl:text>Lamba</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;day&apos;">
              <xsl:text>Land Dayak languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lao&apos;">
              <xsl:text>Lao</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lat&apos;">
              <xsl:text>Latin</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lav&apos;">
              <xsl:text>Latvian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ast&apos;">
              <xsl:text>Leonese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ltz&apos;">
              <xsl:text>Letzeburgesch</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lez&apos;">
              <xsl:text>Lezghian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lim&apos;">
              <xsl:text>Limburgan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lim&apos;">
              <xsl:text>Limburger</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lim&apos;">
              <xsl:text>Limburgish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lin&apos;">
              <xsl:text>Lingala</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lit&apos;">
              <xsl:text>Lithuanian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;jbo&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;nds&apos;">
              <xsl:text>Low Saxon</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;dsb&apos;">
              <xsl:text>Lower Sorbian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;loz&apos;">
              <xsl:text>Lozi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lub&apos;">
              <xsl:text>Luba-Katanga</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lua&apos;">
              <xsl:text>Luba-Lulua</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lui&apos;">
              <xsl:text>Luiseno</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;smj&apos;">
              <xsl:text>Lule Sami</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lun&apos;">
              <xsl:text>Lunda</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;luo&apos;">
              <xsl:text>Luo (Kenya and Tanzania)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lus&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;rup&apos;">
              <xsl:text>Macedo-Romanian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mac/mkd&apos;">
              <xsl:text>Macedonian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mad&apos;">
              <xsl:text>Madurese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mag&apos;">
              <xsl:text>Magahi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mai&apos;">
              <xsl:text>Maithili</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mak&apos;">
              <xsl:text>Makasar</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mlg&apos;">
              <xsl:text>Malagasy</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;may/msa&apos;">
              <xsl:text>Malay</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mal&apos;">
              <xsl:text>Malayalam</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;div&apos;">
              <xsl:text>Maldivian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mlt&apos;">
              <xsl:text>Maltese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mnc&apos;">
              <xsl:text>Manchu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mdr&apos;">
              <xsl:text>Mandar</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;man&apos;">
              <xsl:text>Mandingo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mni&apos;">
              <xsl:text>Manipuri</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mno&apos;">
              <xsl:text>Manobo languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;glv&apos;">
              <xsl:text>Manx</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mao/mri&apos;">
              <xsl:text>Maori</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;arn&apos;">
              <xsl:text>Mapuche</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;arn&apos;">
              <xsl:text>Mapudungun</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mar&apos;">
              <xsl:text>Marathi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chm&apos;">
              <xsl:text>Mari</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mah&apos;">
              <xsl:text>Marshallese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mwr&apos;">
              <xsl:text>Marwari</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mas&apos;">
              <xsl:text>Masai</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;myn&apos;">
              <xsl:text>Mayan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;men&apos;">
              <xsl:text>Mende</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mic&apos;">
              <xsl:text>Mi'kmaq</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mic&apos;">
              <xsl:text>Micmac</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;min&apos;">
              <xsl:text>Minangkabau</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mwl&apos;">
              <xsl:text>Mirandese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;moh&apos;">
              <xsl:text>Mohawk</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mdf&apos;">
              <xsl:text>Moksha</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rum/ron&apos;">
              <xsl:text>Moldavian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rum/ron&apos;">
              <xsl:text>Moldovan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mkh&apos;">
              <xsl:text>Mon-Khmer languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hmn&apos;">
              <xsl:text>Mong</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;lol&apos;">
              <xsl:text>Mongo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mon&apos;">
              <xsl:text>Mongolian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mos&apos;">
              <xsl:text>Mossi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mul&apos;">
              <xsl:text>Multiple languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mun&apos;">
              <xsl:text>Munda languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nqo&apos;">
              <xsl:text>N'Ko</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nah&apos;">
              <xsl:text>Nahuatl languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nau&apos;">
              <xsl:text>Nauru</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nav&apos;">
              <xsl:text>Navaho</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nav&apos;">
              <xsl:text>Navajo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nde&apos;">
              <xsl:text>Ndebele, North</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nbl&apos;">
              <xsl:text>Ndebele, South</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ndo&apos;">
              <xsl:text>Ndonga</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nap&apos;">
              <xsl:text>Neapolitan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;new&apos;">
              <xsl:text>Nepal Bhasa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nep&apos;">
              <xsl:text>Nepali</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;new&apos;">
              <xsl:text>Newari</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nia&apos;">
              <xsl:text>Nias</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nic&apos;">
              <xsl:text>Niger-Kordofanian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ssa&apos;">
              <xsl:text>Nilo-Saharan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;niu&apos;">
              <xsl:text>Niuean</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zxx&apos;">
              <xsl:text>No linguistic content</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nog&apos;">
              <xsl:text>Nogai</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;non&apos;">
              <xsl:text>Norse, Old</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nai&apos;">
              <xsl:text>North American Indian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nde&apos;">
              <xsl:text>North Ndebele</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;frr&apos;">
              <xsl:text>Northern Frisian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sme&apos;">
              <xsl:text>Northern Sami</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nso&apos;">
              <xsl:text>Northern Sotho</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nor&apos;">
              <xsl:text>Norwegian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nob&apos;">
              <xsl:text>Norwegian Bokmål</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nno&apos;">
              <xsl:text>Norwegian Nynorsk</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zxx&apos;">
              <xsl:text>Not applicable</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nub&apos;">
              <xsl:text>Nubian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;iii&apos;">
              <xsl:text>Nuosu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nym&apos;">
              <xsl:text>Nyamwezi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nya&apos;">
              <xsl:text>Nyanja</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nyn&apos;">
              <xsl:text>Nyankole</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nno&apos;">
              <xsl:text>Nynorsk, Norwegian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nyo&apos;">
              <xsl:text>Nyoro</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nzi&apos;">
              <xsl:text>Nzima</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ile&apos;">
              <xsl:text>Occidental</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;oci&apos;">
              <xsl:text>Occitan (post 1500)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pro&apos;">
              <xsl:text>Occitan, Old (to 1500)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;arc&apos;">
              <xsl:text>Official Aramaic (700-300 BCE)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;xal&apos;">
              <xsl:text>Oirat</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;oji&apos;">
              <xsl:text>Ojibwa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chu&apos;">
              <xsl:text>Old Bulgarian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chu&apos;">
              <xsl:text>Old Church Slavonic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nwc&apos;">
              <xsl:text>Old Newari</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;chu&apos;">
              <xsl:text>Old Slavonic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ori&apos;">
              <xsl:text>Oriya</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;orm&apos;">
              <xsl:text>Oromo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;osa&apos;">
              <xsl:text>Osage</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;oss&apos;">
              <xsl:text>Ossetian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;oss&apos;">
              <xsl:text>Ossetic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;oto&apos;">
              <xsl:text>Otomian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pal&apos;">
              <xsl:text>Pahlavi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pau&apos;">
              <xsl:text>Palauan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pli&apos;">
              <xsl:text>Pali</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pam&apos;">
              <xsl:text>Pampanga</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pag&apos;">
              <xsl:text>Pangasinan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pan&apos;">
              <xsl:text>Panjabi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pap&apos;">
              <xsl:text>Papiamento</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;paa&apos;">
              <xsl:text>Papuan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pus&apos;">
              <xsl:text>Pashto</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nso&apos;">
              <xsl:text>Pedi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;per/fas&apos;">
              <xsl:text>Persian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;peo&apos;">
              <xsl:text>Persian, Old (ca.600-400 B.C.)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;phi&apos;">
              <xsl:text>Philippine languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;phn&apos;">
              <xsl:text>Phoenician</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fil&apos;">
              <xsl:text>Pilipino</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;pon&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;pra&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;que&apos;">
              <xsl:text>Quechua</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;raj&apos;">
              <xsl:text>Rajasthani</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rap&apos;">
              <xsl:text>Rapanui</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rar&apos;">
              <xsl:text>Rarotongan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;qaa-qtz&apos;">
              <xsl:text>Reserved for local use</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;roa&apos;">
              <xsl:text>Romance languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rum/ron&apos;">
              <xsl:text>Romanian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;roh&apos;">
              <xsl:text>Romansh</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;rom&apos;">
              <xsl:text>Romany</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;run&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;kho&apos;">
              <xsl:text>Sakan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sal&apos;">
              <xsl:text>Salishan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sam&apos;">
              <xsl:text>Samaritan Aramaic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;smi&apos;">
              <xsl:text>Sami languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;smo&apos;">
              <xsl:text>Samoan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sad&apos;">
              <xsl:text>Sandawe</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sag&apos;">
              <xsl:text>Sango</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;san&apos;">
              <xsl:text>Sanskrit</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sat&apos;">
              <xsl:text>Santali</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;srd&apos;">
              <xsl:text>Sardinian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sas&apos;">
              <xsl:text>Sasak</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nds&apos;">
              <xsl:text>Saxon, Low</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sco&apos;">
              <xsl:text>Scots</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gla&apos;">
              <xsl:text>Scottish Gaelic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sel&apos;">
              <xsl:text>Selkup</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sem&apos;">
              <xsl:text>Semitic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nso&apos;">
              <xsl:text>Sepedi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;srp&apos;">
              <xsl:text>Serbian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;srr&apos;">
              <xsl:text>Serer</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;shn&apos;">
              <xsl:text>Shan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sna&apos;">
              <xsl:text>Shona</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;iii&apos;">
              <xsl:text>Sichuan Yi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;scn&apos;">
              <xsl:text>Sicilian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sid&apos;">
              <xsl:text>Sidamo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sgn&apos;">
              <xsl:text>Sign Languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;bla&apos;">
              <xsl:text>Siksika</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;snd&apos;">
              <xsl:text>Sindhi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sin&apos;">
              <xsl:text>Sinhala</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sin&apos;">
              <xsl:text>Sinhalese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sit&apos;">
              <xsl:text>Sino-Tibetan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sio&apos;">
              <xsl:text>Siouan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sms&apos;">
              <xsl:text>Skolt Sami</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;den&apos;">
              <xsl:text>Slave (Athapascan)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sla&apos;">
              <xsl:text>Slavic languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;slo/slk&apos;">
              <xsl:text>Slovak</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;slv&apos;">
              <xsl:text>Slovenian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sog&apos;">
              <xsl:text>Sogdian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;som&apos;">
              <xsl:text>Somali</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;son&apos;">
              <xsl:text>Songhai languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;snk&apos;">
              <xsl:text>Soninke</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;wen&apos;">
              <xsl:text>Sorbian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nso&apos;">
              <xsl:text>Sotho, Northern</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sot&apos;">
              <xsl:text>Sotho, Southern</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sai&apos;">
              <xsl:text>South American Indian languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;nbl&apos;">
              <xsl:text>South Ndebele</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;alt&apos;">
              <xsl:text>Southern Altai</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sma&apos;">
              <xsl:text>Southern Sami</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;spa&apos;">
              <xsl:text>Spanish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;srn&apos;">
              <xsl:text>Sranan Tongo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zgh&apos;">
              <xsl:text>Standard Moroccan Tamazight</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;suk&apos;">
              <xsl:text>Sukuma</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sux&apos;">
              <xsl:text>Sumerian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sun&apos;">
              <xsl:text>Sundanese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sus&apos;">
              <xsl:text>Susu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;swa&apos;">
              <xsl:text>Swahili</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ssw&apos;">
              <xsl:text>Swati</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;swe&apos;">
              <xsl:text>Swedish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;gsw&apos;">
              <xsl:text>Swiss German</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;syr&apos;">
              <xsl:text>Syriac</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tgl&apos;">
              <xsl:text>Tagalog</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tah&apos;">
              <xsl:text>Tahitian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tai&apos;">
              <xsl:text>Tai languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tgk&apos;">
              <xsl:text>Tajik</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tmh&apos;">
              <xsl:text>Tamashek</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tam&apos;">
              <xsl:text>Tamil</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tat&apos;">
              <xsl:text>Tatar</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tel&apos;">
              <xsl:text>Telugu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ter&apos;">
              <xsl:text>Tereno</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tet&apos;">
              <xsl:text>Tetum</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tha&apos;">
              <xsl:text>Thai</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tib/bod&apos;">
              <xsl:text>Tibetan</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tig&apos;">
              <xsl:text>Tigre</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tir&apos;">
              <xsl:text>Tigrinya</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tem&apos;">
              <xsl:text>Timne</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tiv&apos;">
              <xsl:text>Tiv</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tlh&apos;">
              <xsl:text>tlhIngan-Hol</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tli&apos;">
              <xsl:text>Tlingit</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tpi&apos;">
              <xsl:text>Tok Pisin</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tkl&apos;">
              <xsl:text>Tokelau</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tog&apos;">
              <xsl:text>Tonga (Nyasa)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ton&apos;">
              <xsl:text>Tonga (Tonga Islands)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tsi&apos;">
              <xsl:text>Tsimshian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tso&apos;">
              <xsl:text>Tsonga</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tsn&apos;">
              <xsl:text>Tswana</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tum&apos;">
              <xsl:text>Tumbuka</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tup&apos;">
              <xsl:text>Tupi languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tur&apos;">
              <xsl:text>Turkish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ota&apos;">
              <xsl:text>Turkish, Ottoman (1500-1928)</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tuk&apos;">
              <xsl:text>Turkmen</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tvl&apos;">
              <xsl:text>Tuvalu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;tyv&apos;">
              <xsl:text>Tuvinian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;twi&apos;">
              <xsl:text>Twi</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;udm&apos;">
              <xsl:text>Udmurt</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;uga&apos;">
              <xsl:text>Ugaritic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;uig&apos;">
              <xsl:text>Uighur</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ukr&apos;">
              <xsl:text>Ukrainian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;umb&apos;">
              <xsl:text>Umbundu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;mis&apos;">
              <xsl:text>Uncoded languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;und&apos;">
              <xsl:text>Undetermined</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;hsb&apos;">
            ...
            <xsl:when test="n1:languageCode/@code  = &apos;uig&apos;">
              <xsl:text>Uyghur</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;uzb&apos;">
              <xsl:text>Uzbek</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;vai&apos;">
              <xsl:text>Vai</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;cat&apos;">
              <xsl:text>Valencian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ven&apos;">
              <xsl:text>Venda</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;vie&apos;">
              <xsl:text>Vietnamese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;vol&apos;">
              <xsl:text>Volapük</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;vot&apos;">
              <xsl:text>Votic</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;wak&apos;">
              <xsl:text>Wakashan languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;wln&apos;">
              <xsl:text>Walloon</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;war&apos;">
              <xsl:text>Waray</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;was&apos;">
              <xsl:text>Washo</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;wel/cym&apos;">
              <xsl:text>Welsh</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;fry&apos;">
              <xsl:text>Western Frisian</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;him&apos;">
              <xsl:text>Western Pahari languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;wal&apos;">
              <xsl:text>Wolaitta</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;wal&apos;">
              <xsl:text>Wolaytta</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;wol&apos;">
              <xsl:text>Wolof</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;xho&apos;">
              <xsl:text>Xhosa</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;sah&apos;">
              <xsl:text>Yakut</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;yao&apos;">
              <xsl:text>Yao</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;yap&apos;">
              <xsl:text>Yapese</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;yid&apos;">
              <xsl:text>Yiddish</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;yor&apos;">
              <xsl:text>Yoruba</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;ypk&apos;">
              <xsl:text>Yupik languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;znd&apos;">
              <xsl:text>Zande languages</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zap&apos;">
              <xsl:text>Zapotec</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zza&apos;">
              <xsl:text>Zaza</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zza&apos;">
              <xsl:text>Zazaki</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zen&apos;">
              <xsl:text>Zenaga</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zha&apos;">
              <xsl:text>Zhuang</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zul&apos;">
              <xsl:text>Zulu</xsl:text>
            </xsl:when>
            <xsl:when test="n1:languageCode/@code  = &apos;zun&apos;">
